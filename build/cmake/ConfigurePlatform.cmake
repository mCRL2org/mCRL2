...
elseif(UNIX)
  ...
  if(APPLE)
    ...
    # Platform is Mac OSX
    #set(CMAKE_EXE_LINKER_FLAGS "-framework Cocoa ${CMAKE_EXE_LINKER_FLAGS}")
    #set(CMAKE_SHARED_LINKER_FLAGS "-framework Cocoa -single_module ${CMAKE_SHARED_LINKER_FLAGS}")
    #set(CMAKE_MODULE_LINKER_FLAGS "-framework Cocoa ${CMAKE_SHARED_LINKER_FLAGS}")
    ...
    set(MCRL2_BUNDLE_PATH /Applications/mCRL2)

    set(CMAKE_MACOSX_RPATH ON)
    set(CMAKE_INSTALL_RPATH "@loader_path/../${MCRL2_LIBRARY_PATH}")
...
set(CMAKE_BUNDLE_OUTPUT_DIRECTORY ${MCRL2_STAGE_PATH}/${MCRL2_BUNDLE_PATH})
