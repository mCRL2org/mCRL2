...
if(NOT MCRL2_ENABLE_EXPERIMENTAL)
  set(_skip_tests "lpsrealelm;besconvert;bessolve;pbesabstract;pbesinst;pbespareqelm;lpsbisim2pbes;txt2bes" CACHE INTERNAL "Used internally by GenerateToolTests.cmake" FORCE)
else()
...
function(gen_pbes2bool_release_tests PBESFILE)
  set(ARGUMENTS "-c" "-H" "-psimplify" "-pquantifier-all" "-pquantifier-finite" "-ppfnf" 
                "-rjitty" "-rjittyp" ${_JITTYC} "-s0" "-s1" "-s2" "-s3" "-t" "-u")
  foreach(arglist ${ARGUMENTS})
...
function(gen_pbes2bes_release_tests PBESFILE BESFILE)
  set(ARGUMENTS "-H" "-opbes" "-ocwi" "-obes" "-opgsolver" "-psimplify" "-pquantifier-all" 
                "-pquantifier-finite" "-ppfnf" "-rjitty" "-rjittyp" ${_JITTYC} 
                "-s0" "-s1" "-s2" "-s3" "-t" "-u")
...
# pbesabstract
function(gen_pbesabstract_release_tests PBESFILE)
  add_tool_test(pbesabstract -a0 ${tagIN} ${PBESFILE})
  add_tool_test(pbesabstract -a1 ${tagIN} ${PBESFILE})
endfunction()

# pbesinst
function(gen_pbesinst_release_tests PBESFILE)
  set(ARGUMENTS "" "-opbes" "-obes" "-ocwi" "-opgsolver" "-slazy" "-sfinite\;-f\"*(*:Bool)\"" "-rjitty" "-rjittyp" ${_JITTYC})
  foreach(arglist ${ARGUMENTS})
