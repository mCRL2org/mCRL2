...
if __name__ == "__main__":
    ...
    result = make_builder('../../lps/include/mcrl2/lps/builder.h'          , 'sort_expression_builder', 'add_sort_expressions', 'process::sort_expression_builder'            , class_map, all_classes, 'lps'             , 'data::sort_expression', sort_expression_dependencies, modifiability_map) and result
    result = make_builder('../../process/include/mcrl2/process/builder.h'  , 'sort_expression_builder', 'add_sort_expressions', 'data::sort_expression_builder'            , class_map, all_classes, 'process'         , 'data::sort_expression', sort_expression_dependencies, modifiability_map) and result
    ...
    result = make_builder('../../lps/include/mcrl2/lps/builder.h'          , 'data_expression_builder', 'add_data_expressions', 'process::data_expression_builder'            , class_map, all_classes, 'lps'             , 'data::data_expression', data_expression_dependencies, modifiability_map) and result
    result = make_builder('../../process/include/mcrl2/process/builder.h'  , 'data_expression_builder', 'add_data_expressions', 'data::data_expression_builder'            , class_map, all_classes, 'process'         , 'data::data_expression', data_expression_dependencies, modifiability_map) and result
    ...
    result = make_builder('../../lps/include/mcrl2/lps/builder.h'          , 'variable_builder', 'add_variables', 'process::data_expression_builder'            , class_map, all_classes, 'lps'             , 'data::data_expression', variable_dependencies, modifiability_map) and result
    result = make_builder('../../process/include/mcrl2/process/builder.h'  , 'variable_builder', 'add_variables', 'data::data_expression_builder'            , class_map, all_classes, 'process'         , 'data::data_expression', variable_dependencies, modifiability_map) and result
    ...
    result = make_builder('../../process/include/mcrl2/process/builder.h', 'process_expression_builder', 'add_process_expressions', 'core::builder', class_map, all_classes, 'process', 'process::process_expression', process_expression_dependencies, modifiability_map) and result
    ...
    result = make_traverser('../../lps/include/mcrl2/lps/traverser.h'          , 'sort_expression_traverser', 'add_traverser_sort_expressions', 'process::sort_expression_traverser'            , class_map, all_classes, 'lps'             , 'data::sort_expression', sort_expression_dependencies) and result
    result = make_traverser('../../process/include/mcrl2/process/traverser.h'  , 'sort_expression_traverser', 'add_traverser_sort_expressions', 'data::sort_expression_traverser'             , class_map, all_classes, 'process'         , 'data::sort_expression', sort_expression_dependencies) and result
    ...
    result = make_traverser('../../lps/include/mcrl2/lps/traverser.h'          , 'data_expression_traverser', 'add_traverser_data_expressions', 'process::data_expression_traverser'            , class_map, all_classes, 'lps'             , 'data::data_expression', data_expression_dependencies) and result
    result = make_traverser('../../process/include/mcrl2/process/traverser.h'  , 'data_expression_traverser', 'add_traverser_data_expressions', 'data::data_expression_traverser'             , class_map, all_classes, 'process'         , 'data::data_expression', data_expression_dependencies) and result
    ...
    result = make_traverser('../../lps/include/mcrl2/lps/traverser.h'          , 'variable_traverser', 'add_traverser_variables', 'process::variable_traverser'            , class_map, all_classes, 'lps'             , 'data::variable', variable_dependencies) and result
    result = make_traverser('../../process/include/mcrl2/process/traverser.h'  , 'variable_traverser', 'add_traverser_variables', 'data::variable_traverser'             , class_map, all_classes, 'process'         , 'data::variable', variable_dependencies) and result
    ...
    result = make_traverser('../../process/include/mcrl2/process/traverser.h', 'action_label_traverser', 'add_traverser_action_labels', 'core::traverser', class_map, all_classes, 'process', 'process::action_label', action_label_dependencies) and result
    result = make_traverser('../../lps/include/mcrl2/lps/traverser.h', 'action_label_traverser', 'add_traverser_action_labels', 'process::action_label_traverser', class_map, all_classes, 'lps', 'process::action_label', action_label_dependencies) and result
    ...
    result = make_traverser('../../lps/include/mcrl2/lps/traverser.h'          , 'identifier_string_traverser', 'add_traverser_identifier_strings', 'process::identifier_string_traverser'            , class_map, all_classes, 'lps'             , 'core::identifier_string', identifier_string_dependencies) and result
    result = make_traverser('../../process/include/mcrl2/process/traverser.h'  , 'identifier_string_traverser', 'add_traverser_identifier_strings', 'data::identifier_string_traverser'             , class_map, all_classes, 'process'         , 'core::identifier_string', identifier_string_dependencies) and result
    ...
    result = make_traverser('../../process/include/mcrl2/process/traverser.h', 'process_expression_traverser', 'add_traverser_process_expressions', 'core::traverser', class_map, all_classes, 'process', 'process::process_expression', process_expression_dependencies) and result
