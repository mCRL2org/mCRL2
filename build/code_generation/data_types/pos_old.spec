...
%
% Specification of the Pos_old data sort.
% This was the standard definition of data types until it was
% replaced by the machine based data types in 2018/2019. 

#include bool.spec

sort Pos_old <"pos_old">;

cons @c1 <"c1">:Pos_old                                          internal defined_by_rewrite_rules;
     @cDub <"cdub">:Bool <"left"> #Pos_old <"right"> ->Pos_old   internal defined_by_rewrite_rules;

map max <"maximum">:Pos_old <"left"> #Pos_old <"right">->Pos_old external defined_by_rewrite_rules;
    min <"minimum">:Pos_old <"left"> #Pos_old <"right">->Pos_old external defined_by_rewrite_rules;
    succ <"succ">:Pos_old <"arg">->Pos_old                       external defined_by_rewrite_rules;
    @pospred <"pos_predecessor">:Pos_old <"arg">->Pos_old        internal defined_by_rewrite_rules;
    + <"plus">:Pos_old <"left"> #Pos_old <"right">->Pos_old      external defined_by_rewrite_rules;
    @addc <"add_with_carry">:Bool <"arg1"> #Pos_old <"arg2"> #Pos_old <"arg3">->Pos_old
                                                                 internal defined_by_rewrite_rules;
    * <"times">:Pos_old <"left"> #Pos_old <"right">->Pos_old     external defined_by_rewrite_rules;
    @powerlog2 <"powerlog2_pos">:Pos_old <"arg"> -> Pos_old      internal defined_by_rewrite_rules;
