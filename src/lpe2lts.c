...
static void print_help(FILE *f, char *Name)
{
	...
	fprintf(f,"Generate state space of LPEFILE and save the result to OUTFILE (in the aut\n"
		  "format). If OUTFILE is not supplied, the state space is not stored.\n"
		  "\n"
		  "The format of OUTFILE is determined by its extension (unless the format is\n"
		  "explicitly specified with an option). If no known extension is used, the aut\n"
		  "format will be used.\n"
	          "\n"
