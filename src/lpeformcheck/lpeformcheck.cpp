  ...
  // Class LPE_Form_Check - Functions declared private --------------------------------------------
    ...
    void LPE_Form_Check::print_help() {
      fprintf(stderr,
        ...
        "  -l, --lpe=LPE                   Use the data specification of the mCRL2 LPE\n"
        "                                  as found in LPE as input.\n"
        "  -c, --counter-example           Give a valuation for which the formula\n"
        "                                  does not hold.\n"
        "  -w, --witness                   Give a valuation for which the formula\n"
        "                                  holds.\n"
