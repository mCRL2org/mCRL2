  ...
  namespace tool {
    ...
    class Tool {
      ...
      private:
        ...
        void Read(xml2pp::text_reader& reader);
    ...
    /* Abstract type that describes an input or output object of a tool instance */
    class ToolObject {
    ...
    class ToolInputObject : public ToolObject {
      ...
      private:
        ...
        /* Read from XML using a libXML2 reader */
        inline void Read(xml2pp::text_reader& reader);
