...
namespace squadt {
  namespace GUI {
    ...
    void project::load_views() {
      ...
      while (!id_stack.empty()) {
        ...
        for (wxTreeItemId j = object_view->GetFirstChild(c, cookie);
          ...
          processor::sptr t = static_cast < node_data* > (object_view->GetItemData(j))->target->generator.lock();
    ...
    void project::spawn_context_menu(processor::object_descriptor const& t) {
      ...
      bool generated = (0 < t.generator.lock()->number_of_inputs());
    ...
    void project::on_context_menu_select(wxCommandEvent& e) {
      ...
      processor::sptr               p = t->generator.lock();
