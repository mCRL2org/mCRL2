...
#include "smt_lib_solver.h"
  ...
  /// The class SMT_Solver_CVC_Lite inherits from the class SMT_LIB_Solver. It uses the SMT solver CVC Lite
  ...
  ///
  /// The constructor SMT_Solver_CVC_Lite::SMT_Solver_CVC_Lite checks if CVC Lite's executable is indeed available and
  /// reports an error if it is not.
  ///
  /// The method SMT_Solver_CVC_Lite::is_satisfiable receives a formula in conjunctive normal form as parameter a_formula and
