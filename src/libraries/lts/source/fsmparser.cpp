...
#line 15 "../source/fsmparser.yy"
typedef union YYSTYPE {
  ATermAppl aterm;
  int number;
} YYSTYPE;
/* Line 190 of yacc.c.  */
#line 129 "../source/fsmparser.cpp"
...
#line 34 "../source/fsmparser.yy"
  ...
  case 11:
#line 67 "../source/fsmparser.yy"
    { 
	    fsm_lexer_obj->typeValues = ATempty;
	    fsm_lexer_obj->typeId = (yyvsp[0].aterm);
	    
	  ;}
    break;

  case 12:
#line 73 "../source/fsmparser.yy"
    { 
  ...
  case 13:
#line 81 "../source/fsmparser.yy"
    { (yyval.aterm) = ATmakeAppl0( ATmakeAFun( "", 0, ATfalse ) ) ;}
    break;

  case 14:
#line 84 "../source/fsmparser.yy"
    { (yyval.aterm) = (yyvsp[0].aterm) ;}
    break;

  case 15:
#line 87 "../source/fsmparser.yy"
    {
  ...
  case 16:
#line 96 "../source/fsmparser.yy"
    { (yyval.aterm) = (yyvsp[0].aterm) ;}
    break;

  case 17:
#line 99 "../source/fsmparser.yy"
    {
  ...
  case 20:
#line 115 "../source/fsmparser.yy"
    { fsm_lexer_obj->typeValues = ATinsert( fsm_lexer_obj->typeValues, (ATerm)ATmakeAppl2(
	      fsm_lexer_obj->const_ATvalue, (ATerm)(yyvsp[0].aterm), (ATerm)fsm_lexer_obj->typeId ) ) ;}
    break;

  case 31:
#line 151 "../source/fsmparser.yy"
    {
...
#line 165 "../source/fsmparser.yy"
    { 
		...
		(ATermList)ATelementAt( fsm_lexer_obj->valueTable, paramNo ), (yyvsp[0].number) ) );
	    }
	  ;}
    break;

  case 37:
#line 186 "../source/fsmparser.yy"
    {
	    unsigned int frState = (yyvsp[-2].number)-1;
	    unsigned int toState = (yyvsp[-1].number)-1;
	    ATerm label = ATtableGet(fsm_lexer_obj->labelTable,(ATerm)(yyvsp[0].aterm));
	    if ( label == NULL )
	    {
	    	unsigned int i = fsm_lexer_obj->fsm_lts->add_label((ATerm)(yyvsp[0].aterm));
		label = (ATerm) ATmakeInt(i);
		ATtablePut(fsm_lexer_obj->labelTable,(ATerm)(yyvsp[0].aterm),label);
	    }
  ...
  case 38:
#line 202 "../source/fsmparser.yy"
    { (yyval.aterm) = ATmakeAppl0( ATmakeAFun( "", 0, ATfalse ) ) ;}
    break;

  case 39:
#line 205 "../source/fsmparser.yy"
    { (yyval.aterm) = (yyvsp[0].aterm) ;}
    break;
...
/* Line 1037 of yacc.c.  */
#line 1206 "../source/fsmparser.cpp"

  yyvsp -= yylen;
  yyssp -= yylen;
