...
struct aterm_traits<ATermList>
{
  ...
  static void protect(ATermList t)   { ATprotect(reinterpret_cast<ATerm*>(&t)); }
  static void unprotect(ATermList t) { ATunprotect(reinterpret_cast<ATerm*>(&t)); }
  static void mark(ATermList t)      { ATmarkTerm(reinterpret_cast<ATerm*>(&t)); }
...
struct aterm_traits<ATermAppl>
{
  ...
  static void protect(ATermAppl t)   { ATprotect(reinterpret_cast<ATerm*>(&t)); }
  static void unprotect(ATermAppl t) { ATunprotect(reinterpret_cast<ATerm*>(&t)); }
  static void mark(ATermAppl t)      { ATmarkTerm(reinterpret_cast<ATerm*>(&t)); }
...
{                                     
  ...
  static void protect(ATermBlob t)   { ATprotect(reinterpret_cast<ATerm*>(&t)); }
  static void unprotect(ATermBlob t) { ATunprotect(reinterpret_cast<ATerm*>(&t)); }
  static void mark(ATermBlob t)      { ATmarkTerm(reinterpret_cast<ATerm*>(&t)); }
...
{                                     
  ...
  static void protect(ATermReal t)   { ATprotect(reinterpret_cast<ATerm*>(&t)); }
  static void unprotect(ATermReal t) { ATunprotect(reinterpret_cast<ATerm*>(&t)); }
  static void mark(ATermReal t)      { ATmarkTerm(reinterpret_cast<ATerm*>(&t)); }
...
{                                     
  ...
  static void protect(ATermInt t)    { ATprotect(reinterpret_cast<ATerm*>(&t)); }
  static void unprotect(ATermInt t)  { ATunprotect(reinterpret_cast<ATerm*>(&t)); }
  static void mark(ATermInt t)       { ATmarkTerm(reinterpret_cast<ATerm*>(&t)); }
