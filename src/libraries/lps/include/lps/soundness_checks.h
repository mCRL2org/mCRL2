#ifndef LPS_SOUNDNESS_CHECKS_H
#define LPS_SOUNDNESS_CHECKS_H
...
template <typename Term> bool check_rule_LPSSummand(Term t);
...
template <typename Term> bool check_term_LPS(Term t);
...
template <typename Term> bool check_term_LPSSummand(Term t);
...
template <typename Term> bool check_term_LPSInit(Term t);
...
template <typename Term>
bool check_rule_LPSSummand(Term t)
{
  return    check_term_LPSSummand(t);
}
...
// LPS(DataVarId*, DataVarId*, LPSSummand*)
template <typename Term>
bool check_term_LPS(Term t)
{
  // check the type of the term
  aterm term(aterm_traits<Term>::term(t));
  if (term.type() != AT_APPL)
  ...
  if (!check_list_argument(a(1), check_rule_DataVarId<aterm>, 0))
    return false;
  if (!check_list_argument(a(2), check_rule_LPSSummand<aterm>, 0))
    return false;
#endif // LPS_NO_RECURSIVE_SOUNDNESS_CHECKS
...
// LPSSummand(DataVarId*, DataExpr, MultActOrDelta, DataExprOrNil, DataVarIdInit*)
template <typename Term>
bool check_term_LPSSummand(Term t)
{
  // check the type of the term
  aterm term(aterm_traits<Term>::term(t));
  if (term.type() != AT_APPL)
...
// LPSInit(DataVarId*, DataVarIdInit*)
template <typename Term>
bool check_term_LPSInit(Term t)
{
  // check the type of the term
  aterm term(aterm_traits<Term>::term(t));
  if (term.type() != AT_APPL)
