...
{ /* This function gets a list of summands, with
  ...
  return gsMakeLPSSummand(resultsum,
                        resultcondition,
                        ((multiActionIsDelta)?
                            resultmultiaction:
...
ATermAppl linearise_std(ATermAppl spec, t_lin_options lin_options)
{
  ...
  result = gsMakeSpecV1(
    ...
    gsMakeLPS(SieveProcDataVarsSummands(
      ...
      ATreverse(ATLgetArgument(result,2))),  // reverse, to let the list
                                             ...
                                             // input were an LPS.
    gsMakeLPSInit(SieveProcDataVarsAssignments(
                   spec_int->procdatavars,
