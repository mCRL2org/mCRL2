...
SortExpr
  ...
  | SortExprList ('->' $binary_op_right 1) SortExpr                 // higher-order sort
...
DataExpr
  ...
  | DataExpr ('=>' $binary_op_left  1)  DataExpr
...
ProcExprNoIf
  ...
  | ProcExprNoIf ('.' $binary_op_left 6) ProcExprNoIf
  | ProcExprNoIf ('@' $binary_op_left 7) DataExprUnit
  | ProcExprNoIf ('|' $binary_op_left 7) ProcExprNoIf
  ;
