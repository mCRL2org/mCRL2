...
from pygments.token import Comment, Whitespace, Number, Operator, Name, Keyword, String
...
class mCRL2Lexer(RegexLexer):
    ...
    tokens = {
        ...
        "decimal": [(r"[0]", Number), (r"[1-9][0-9]*", Number)],
        "operator": [
            (r"\.", Operator),
            (r"\+", Operator),
            (r"\|", Operator),
        ...
        "identifier": [(r"[a-zA-z_'][a-zA-Z0-9_']*", String)],
        "root": [
            include("keywords"),
            include("comment"),
            include("whitespace"),
