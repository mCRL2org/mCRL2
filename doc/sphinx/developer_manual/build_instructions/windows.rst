...
additional dependencies that are listed at the end.
  ...
  * Qt version at least 6.2.4. Download and install `Qt <https://www.qt.io/download-qt-installer>`_, which requires a Qt account. Alternatively, install `Conda <https://docs.conda.io>`_ and install the qt6-base package.
  * `CMake 3.14.0 <http://www.cmake.org/cmake/resources/software.html>`_ must be installed.
  * `Python 3.9 <https://www.python.org/>`_ or higher is optionally needed for various activities such as testing, building documentation and code generation.
