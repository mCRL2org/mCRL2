...
R_{\forall}(V, \bigvee_i \phi_i)&=&
   \left\{
     \begin{array}{l}
       \forall V. \bigvee_i \phi_i \hspace{3cm} \text{ if } \neg \Phi \lor \neg \Psi \\
...
R_{\exists}(V, \bigwedge_i \phi_i)&=&
   \left\{
     \begin{array}{l}
       \exists V. \bigwedge_i \phi_i \hspace{3cm} \text{ if } \Phi \lor \Psi \\

      \exists V \cap \vars(\Phi) \cap \vars(\Psi).
      \left(
           R_\exists(V \cap \vars(\Phi) \setminus \vars(\Psi), \Phi) \lor R_\exists(V \cap \vars(\Psi) \setminus \vars(\Phi), \Psi)
        \right) \text{ otherwise}
    \end{array}
     \right.
  \\
