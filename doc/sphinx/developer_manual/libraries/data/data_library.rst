...
`Capture-avoiding substitutions`_ section.
...
using the data expression grammar from the `Data expressions`_ section.
...
and where :math:`\sigma' = \sigma[v := v']`. The function :math:`C` can be
extended to assignments as follows [#cas-assigns]_:
...
.. [#cas-assigns] The definition of :math:`C` to assignments is not correct and
   not how they have been implemented.
