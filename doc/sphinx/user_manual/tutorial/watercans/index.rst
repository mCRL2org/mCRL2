...
.. warning::
   ...
   following output::
     ...
     Generated 25 new internal processes. If linearisation does not terminate, the use of the flag `--lin-method=regular2' or `--lin-method=stack' in mcrl22lps can help.
     Generated 125 new internal processes. If linearisation does not terminate, the use of the flag `--lin-method=regular2' or `--lin-method=stack' in mcrl22lps can help.
     ...
...
An LTS generated by :ref:`tool-mcrl22lps` and :ref:`tool-lps2lts` has 73 states
and 335 transitions::

   $ mcrl22lps -lregular2 watercan2.mcrl2 | lps2lts -v
   ...
   Done with state space generation (6 levels, 73 states and 335 transitions)
