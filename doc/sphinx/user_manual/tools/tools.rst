...
* A VSCode `extension <https://marketplace.visualstudio.com/items/?itemName=CptWesley.mcrl2>` similar to the `mcrl2ide`, allowing visualisation, simulation and verification.
