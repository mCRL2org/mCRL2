...
def generate_download_inc_files(temp_dev, temp_usr, version, release_tag='@MCRL2_MAJOR_VERSION@', nightly_tag='@MCRL2_VERSION@'):
  ...
  dest_release = '{}'.format(version[0])
  dest_nightly = '{}.{}'.format(version[0], version1)
  release_text = re.sub(release_tag, dest_release, release_text)
  nightly_text = re.sub(nightly_tag, dest_nightly, nightly_text)
