...
%TCIDATA{LastRevised=Thursday, March 14, 2013 14:20:15}
...
\begin{equation*}
\begin{tabular}{l}
\textsc{ResetVariableLocal(}$Y(e)$, $i,$ $V_{1},\cdots ,V_{K}$\textsc{)} \\ 
$\varphi :=true$ \\ 
...
$\qquad \qquad \qquad $\textbf{for} $d_{Y}[m]$ such that $d_{Y}[j]\in
belongs(d_{Y}[m])$ \\ 
