...
%TCIDATA{LastRevised=Thursday, March 14, 2013 09:31:47}
...
\begin{equation*}
\begin{tabular}{l}
\textsc{ResetVariable(}$k$, $X(e)$, $V$\textsc{)} \\ 
$\varphi :=true$ \\ 
...
$\qquad \qquad \qquad $\textbf{if} $dest(Y,k,j)=\bot $ \\ 
$\qquad \qquad \qquad \qquad c:=c\wedge (e[j]=f[i])$ \\ 
