...
marking(u)=\{d\mid (X,d)\in B_{j}\}$ \textbf{then continue} \\ 
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad m:=marking(u)$ \\ 
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad marking(u):=$ 
\textsc{UpdateMarkingRule2(}$i$, $(V_{j},E_{j},B_{j})$, $(V_{k},E_{k},B_{k})$%
, $u$, $v$\textsc{)} \\ 
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \text{\textbf{if }}%
