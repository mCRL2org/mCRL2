...
$\qquad $\textbf{for} $u=(X,p,d_{X}[p]=e)\in V_{k}$ \textbf{do} \\ 
...
$\qquad \qquad \qquad $\textbf{choose} $v=(X,p,d_{X}[p]=e)\in todo$ \\ 
$\qquad \qquad \qquad todo:=todo\setminus \{v\}$ \\ 
$\qquad \qquad \qquad \text{\textbf{for }}(u,v,i)\in E_{k}\text{ \textbf{do}}
$ \\ 
$\qquad \qquad \qquad \qquad $\textbf{let} $u=(Y,q,d_{Y}[q]=f)$ \\ 
...
\text{ \textbf{do}}$ \\ 
$\qquad \qquad \qquad \qquad $\textbf{let} $Y(f)=\mathrm{PVI}(\varphi _{X},i)
$ \\ 
...
$\qquad \qquad \qquad \qquad \qquad \qquad \wedge \exists
w=(Y,q,d_{Y}[q]=g)\in V_{k^{\prime }}$ \textbf{such that} $d_{Y}[l]\in
marking(w)$ \\ 
...
\end{tabular}%
\end{equation*}%
where $insert(V,E,todo,u,v)$ is shorthand for the statements%
\begin{equation*}
\begin{array}{l}
...
$\qquad \qquad marking(u):=sig(u)\cap \{d\mid (X,d)\in B_{j}\}$ \\ 
$stable:=false$ \\ 
\textbf{while} $\lnot stable$ \textbf{do} \\ 
...
\exists i:(v,i,u)\in E_{j}$ \textbf{then} \\ 
...
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \text{\textbf{for }}%
d_{Y}[l]\in marking(v)\text{ \textbf{do}}$ \\ 
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad $\textbf{if} 
$\left( Y,d_{Y}[l]\right) \notin B_{k}$ \textbf{then} \\ 
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad
m:=marking(u)$ \\ 
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad
marking(u):=$ \textsc{UpdateMarkingRule2(}$i$, $(V_{j},E_{j},B_{j})$, $%
(V_{k},E_{k},B_{k})$, $u$, $v$\textsc{)} \\ 
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \text{%
\textbf{if }}m\neq marking(u)$ \textbf{then} \\ 
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad
\qquad stableint:=false$ \\ 
$\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad
\qquad stableext:=false\qquad \qquad \qquad \qquad \qquad \qquad $%
\end{tabular}%
\end{array}%
\end{equation*}%
\newpage \newpage 
