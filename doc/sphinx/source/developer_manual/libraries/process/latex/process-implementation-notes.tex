...
%TCIDATA{LastRevised=Friday, May 31, 2013 11:31:51}
...
\left\{ 
\begin{array}{ll}
Q(e) & \text{if }((P(e),Q(e))\in W \\ 
P^{\prime }(e) & \text{if }\forall (x,y)\in W:x\neq P(e),%
\end{array}%
\right.  \\ 
\text{where }P(d)=p\text{ is the equation of }P\text{,} \\ 
\text{and where }P^{\prime }(d)=push_{\nabla }\left( A,p[d:=e],W\cup
\{(P(e),P^{\prime }(e))\}\right) \text{ is a new equation}%
\end{array}%
$ \\ 
...
P,\{(P,P^{\prime })\}\right) =push_{\nabla }\left(
\{a\},(a+b),\{(P,P^{\prime })\}\right) \cdot push_{\nabla }\left(
\{a\},P,\{(P,P^{\prime })\}\right) =\cdots =a\cdot P^{\prime }$.
...
push_{\nabla }\left( A,p[d:=e],W\cup \{(P,P)\}\right) & \text{if }P\notin W,%
\end{array}%
\right. \\ 
