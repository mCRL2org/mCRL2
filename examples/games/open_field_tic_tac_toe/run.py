...
os.system('pbesconstelm temp.pbes -v | pbesparelm -v | pbesrewr -pquantifier-all > temp_yellow.pbes')
os.system('lps2pbes -fred_has_a_winning_strategy.mcf temp2.lps temp.pbes')
os.system('pbesconstelm temp.pbes -v | pbesparelm -v | pbesrewr -pquantifier-all > temp_red.pbes')
