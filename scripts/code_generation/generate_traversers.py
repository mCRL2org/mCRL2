...
if __name__ == "__main__":
    ...
    result = make_builder(MCRL2_ROOT + 'libraries/data/include/mcrl2/data/builder.h'        , 'sort_expression_builder', 'add_sort_expressions', 'core::builder'                            , class_map, all_classes, 'data'            , 'data::sort_expression', sort_expression_dependencies, modifiability_map) and result
    ...
    result = make_builder(MCRL2_ROOT + 'libraries/data/include/mcrl2/data/builder.h'        , 'data_expression_builder', 'add_data_expressions', 'core::builder'                            , class_map, all_classes, 'data'            , 'data::data_expression', data_expression_dependencies, modifiability_map) and result
    ...
    # variable_builder
    result = make_builder(MCRL2_ROOT + 'libraries/data/include/mcrl2/data/builder.h'        , 'variable_builder', 'add_variables', 'core::builder'                            , class_map, all_classes, 'data'            , 'data::data_expression', variable_dependencies, modifiability_map) and result
    ...
    result = make_builder(MCRL2_ROOT + 'libraries/modal_formula/include/mcrl2/modal_formula/builder.h', 'action_formula_builder', 'add_action_formula_expressions', 'action_formulas::action_formula_builder_base', class_map, all_classes, 'action_formulas', 'action_formulas::action_formula', action_formula_dependencies, modifiability_map) and result

    # regular_formula_builder
    result = make_builder(MCRL2_ROOT + 'libraries/modal_formula/include/mcrl2/modal_formula/builder.h', 'regular_formula_builder', 'add_regular_formula_expressions', 'regular_formulas::regular_formula_builder_base', class_map, all_classes, 'regular_formulas', 'regular_formulas::regular_formula', regular_formula_dependencies, modifiability_map) and result

    # sort_expression_traverser
    result = make_traverser(MCRL2_ROOT + 'libraries/data/include/mcrl2/data/traverser.h'        , 'sort_expression_traverser', 'add_traverser_sort_expressions', 'core::traverser'                            , class_map, all_classes, 'data'            , 'data::sort_expression', sort_expression_dependencies) and result
    ...
    result = make_traverser(MCRL2_ROOT + 'libraries/data/include/mcrl2/data/traverser.h'        , 'data_expression_traverser', 'add_traverser_data_expressions', 'core::traverser'                            , class_map, all_classes, 'data'            , 'data::data_expression', data_expression_dependencies) and result
    ...
    # variable_traverser
    result = make_traverser(MCRL2_ROOT + 'libraries/data/include/mcrl2/data/traverser.h'        , 'variable_traverser', 'add_traverser_variables', 'core::traverser'                     , class_map, all_classes, 'data'            , 'data::variable', variable_dependencies) and result
    ...
    result = make_traverser(MCRL2_ROOT + 'libraries/modal_formula/include/mcrl2/modal_formula/traverser.h', 'action_formula_traverser', 'add_traverser_action_formula_expressions', 'action_formulas::action_formula_traverser_base', class_map, all_classes, 'action_formulas', 'action_formulas::action_formula', action_formula_dependencies) and result

    # regular_formula_traverser
    result = make_traverser(MCRL2_ROOT + 'libraries/modal_formula/include/mcrl2/modal_formula/traverser.h', 'regular_formula_traverser', 'add_traverser_regular_formula_expressions', 'regular_formulas::regular_formula_traverser_base', class_map, all_classes, 'regular_formulas', 'regular_formulas::regular_formula', regular_formula_dependencies) and result
    result = make_traverser(MCRL2_ROOT + 'libraries/modal_formula/include/mcrl2/modal_formula/traverser.h', 'regular_formula_traverser', 'add_traverser_regular_formula_expressions', 'regular_formulas::regular_formula_traverser', class_map, all_classes, 'state_formulas', 'regular_formulas::regular_formula', regular_formula_dependencies) and result
