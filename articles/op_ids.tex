...
\verb+@.0+$^*$    & \srtpos \To \srtpos    & double and add 0     & number\\
\verb+@.1+$^*$    & \srtpos \To \srtpos    & double and add 1     & number\\
...
\verb+@pred+$^*$  & \srtpos \To \srtpos    & positive predecessor & functional\\
