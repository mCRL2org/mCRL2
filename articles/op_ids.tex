...
Name        & \text{Type}                  & Description      & External repr.\\
\hline
\verb+@1+$^*$       & \srtpos              & one                  & number\\
\verb+@0.+$^*$      & \srtpos \To \srtpos  & double positive      & number\\
\verb+@1.+$^*$      & \srtpos \To \srtpos  & double positive plus one & number\\
\verb+@0+$^*$       & \srtnat              & zero                 & number\\
\verb+@cPosNat+$^*$ & \srtpos \To \srtnat  & positive as natural  & number\\
\verb+@-+$^*$       & \srtpos \To \srtint  & negate positive      & number\\
\verb+@cNatInt+$^*$ & \srtnat \To \srtint  & natural as integer   & number\\
