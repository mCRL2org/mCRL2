...
\verb+-+    & \srtint \To \srtint          & negation             & prefix\\
\verb-+-    & A \times A \To A             & addition             & infix\\
\verb+-+    & \srtint \times \srtint \To \srtint & subtraction    & infix\\
\verb+@double+$^*$  & \srtint \To \srtint  & double               & infix\\
\verb+@-+$^*$ & \srtpos \times \srtpos \To \srtint & subtraction  & infix\\
...
\verb+@pred+$^*$ & \srtpos \To \srtpos     & predecessor          & functional\\
