...
class pbessolvesymbolic_tool: public rewriter_tool<input_output_tool>
{
  ...
  protected:
    ...
    void add_options(utilities::interface_description& desc) override
    {
      ...
      desc.add_option("lace-stacksize", utilities::make_optional_argument("NUM", "0"), "set size of program stack in kilo bytes (0=default stack size)");
      desc.add_option("memory-limit", utilities::make_optional_argument("NUM", "32"), "Sylvan memory limit in gigabytes (default 32)", 'm');
