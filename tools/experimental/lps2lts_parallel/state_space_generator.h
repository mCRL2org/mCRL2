...
//
/// \file tools/experimental/lps2lts_parallel/state_space_generator.h
/// \brief This is an experimental parallel state space generator.

#ifndef TOOLS_STATE_SPACE_GENERATOR_H
#define TOOLS_STATE_SPACE_GENERATOR_H
...
class divergence_detector
{
  ...
  public:
    ...
    bool detect_divergence(const lps::state& s, std::size_t s_index, 
                           ...
                           bool dfs_recursive = false)
    {
      ...
      data::data_expression_list process_parameter_undo = explorer.process_parameter_values(m_sigma);
      ...
      explorer.set_process_parameter_values(process_parameter_undo, m_sigma);
      if (m_max_trace_count > 0 && m_trace_count >= m_max_trace_count)
      {
        explorer.abort();
      }
...
#endif // TOOLS_STATE_SPACE_GENERATOR_H
