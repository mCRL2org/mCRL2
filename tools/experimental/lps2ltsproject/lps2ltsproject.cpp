...
class lps2lts_tool: public parallel_tool<rewriter_tool<input_output_tool>>
{
  ...
  public:
    ...
    bool generate_state_space(const Specification& lpsspec, LTSBuilder& builder)
    {
      ...
      lps::explorer<Stochastic, Timed, Specification, lps::with_projection> explorer(lpsspec, options, rewr);
      lts::state_space_generator<Stochastic, Timed, Specification, lps::with_projection> generator(lpsspec, options, explorer);
