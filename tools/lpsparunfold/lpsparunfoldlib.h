...
class Sorts 
{
  public:
    ...
    Sorts( mcrl2::new_data::data_specification s);
    Sorts( ){ };
    ~Sorts(){};
    void algorithm();
  ...
  private:
    ...
    std::set<mcrl2::new_data::function_symbol> createProjectorFunctions(std::set<mcrl2::new_data::function_symbol> m);

    std::set<mcrl2::new_data::function_symbol> determineAffectedConstructors();
    std::set<mcrl2::new_data::function_symbol> determineAffectedMappings();
    std::set<mcrl2::new_data::function_symbol> newSorts( std::set<mcrl2::new_data::function_symbol> k );
