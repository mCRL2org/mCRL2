...
class DocumentManager : public QWidget
{
  ...
  public:
    ...
    /**
     * @brief Returns the index for the given DocumentWidget object
     * @param document The DocumentWidget object
     */
  ...
  signals:
    ...
    /**
     * @brief Activated if the users wants to close the given document/tab
  ...
  private:
    ...
    Ui::DocumentManager m_ui;     ///< The user interface generated by Qt

  private slots:
    /**
     * @brief Redirects the close request, should be called if a tab close was requested
     * @param index The index of the tab which should be closed
     */
