...
namespace mcrl2 {
  ...
  namespace data {
    ...
    namespace sort_bound {
      ...
      inline
      bool is_inf_function_symbol(const data_expression& e)
      {
      ...
      inline
      bool is_cbound_function_symbol(const data_expression& e)
      {
        if (is_function_symbol(e))
        {
      ...
      ///     number of arguments
      inline
      bool is_cbound_application(const data_expression& e)
      {
        if (is_application(e))
        {
      ...
      inline
      bool is_lt_function_symbol(const data_expression& e)
      {
        if (is_function_symbol(e))
        {
      ...
      ///     number of arguments
      inline
      bool is_lt_application(const data_expression& e)
      {
        if (is_application(e))
        {
      ...
      inline
      bool is_add_function_symbol(const data_expression& e)
      {
        if (is_function_symbol(e))
        {
      ...
      ///     number of arguments
      inline
      bool is_add_application(const data_expression& e)
      {
        if (is_application(e))
        {
      ...
      inline
      bool is_min_b_function_symbol(const data_expression& e)
      {
        if (is_function_symbol(e))
        {
      ...
      ///     number of arguments
      inline
      bool is_min_b_application(const data_expression& e)
      {
        if (is_application(e))
        {
      ...
      inline
      bool is_max_b_function_symbol(const data_expression& e)
      {
        if (is_function_symbol(e))
        {
      ...
      ///     number of arguments
      inline
      bool is_max_b_application(const data_expression& e)
      {
        if (is_application(e))
        {
      ...
      inline
      bool is_not_b_function_symbol(const data_expression& e)
      {
        if (is_function_symbol(e))
        {
      ...
      ///     number of arguments
      inline
      bool is_not_b_application(const data_expression& e)
      {
        if (is_application(e))
        {
