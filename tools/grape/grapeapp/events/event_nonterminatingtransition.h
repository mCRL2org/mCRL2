...
/**
    ...
    {
      private:
        uint       m_ntt; /**< The identifier of the terminating transition that will be created. */
        uint       m_beginstate; /**< The identifier of the beginstate of the terminating transition. */
        uint       m_endstate; /**< The identifier of the endstate of the terminating transition. */
        uint       m_in_diagram; /**< The identifier of the transition will have been added to. */
      public:
        /**
    ...
    {
      private:
        uint                m_ntt;       /**< The identifier of the transition. */
        ...
        uint                m_in_diagram;  /**< The identifier of the diagram the transition is in. */
      public:
    ...
    {
      private:
        uint    m_ntt; /**< Identifier of the to be attached nonterminating transition. */
        uint    m_state; /**< Identifier of the state the nonterminating transition is to be attached to. */
    ...
    {
      private:
        uint    m_ntt; /**< Identifier of the to be detached nonterminating transition. */
