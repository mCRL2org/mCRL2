...
namespace grape
{
  namespace grapeapp
  {
    ...
    {
      private:
        uint                  m_chan; /**< Identifier of the to be created channel. */
        coordinate            m_coord; /**< The coordinate that was clicked. */
        uint                  m_ref; /**< Identifier of the compound reference that was clicked. */
        float                 m_def_chan_width;  /**< The default width of a channel. */
        float                 m_def_chan_height; /**< The default height of a channel. */
        uint                  m_in_diagram; /**< Identifier of the diagram in which the channel will be added. */
      public:
    ...
    {
      private:
        uint                            m_chan; /**< Identifier of the to be deleted channel. */
        ...
        uint                            m_ref; /**< Identifier of the compound reference that the channel belonged to. */
    ...
    {
      private:
        uint        m_channel; /**< A pointer to the channel of which the name is to be changed. */
