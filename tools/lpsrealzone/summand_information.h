// Author(s): Jan Friso Groote, Jeroen Keiren and Thomas Neele
...
#ifndef MCRL2_LPSREALZONE_SUMMAND_INFORMATION_H
#define MCRL2_LPSREALZONE_SUMMAND_INFORMATION_H
...
#endif // MCRL2_LPSREALZONE_SUMMAND_INFORMATION_H