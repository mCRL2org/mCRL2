...
namespace Graph
{
    ...
    SpringLayout::SpringLayout(Graph &graph)
        : m_speed(0.001), m_attraction(0.13), m_repulsion(50.0), m_natLength(50.0), m_controlPointWeight(0.001),
          m_clipMin(Coord3D(0.0, 0.0, 0.0)), m_clipMax(Coord3D(1000.0, 1000.0, 1000.0)),
