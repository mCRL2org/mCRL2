...
bool initialise_lts_generation(lts_generation_options *opts)
{
  ...
  nstate = createNextState((ATermAppl) Spec,!lgopts->usedummies,lgopts->stateformat,createEnumerator((ATermAppl) Spec,createRewriter(mcrl2::data::data_specification(ATAgetArgument((ATermAppl) Spec,0)),lgopts->strat),true),true);
