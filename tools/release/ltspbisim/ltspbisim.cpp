...
class ltsconvert_tool : public input_output_tool
{
  ...
  private:
    ...
    bool load_convert_and_save()
    {
      ...
      if (tool_options.equivalence != lts_probabilistic_equivalence::lts_probabilistic_eq_none)
      {
        ...
        mCRL2log(log_level_t::verbose) << "Before reduction: " << l.num_states() << "u states and " << l.num_transitions() << " transitions." << std::endl;
      ...
      switch (tool_options.outtype)
      {
        ...
        {
          mCRL2log(log_level_t::warning) << "Probabilistic bisimulation on a .dot file has not been implemented.";
          break;
        }
  ...
  public:
    bool run() override
    {
      ...
      switch (tool_options.intype)
      {
        ...
        case lts_type::lts_dot:
        {
          mCRL2log(log_level_t::warning) << "Ltspbisim does not work on a .dot file. ";
          break;
        }
  ...
  void parse_options(const command_line_parser& parser) override
  {
    ...
    /* if (tool_options.determinise && (tool_options.equivalence != lts_probabilistic_equivalence::lts_probabilistic_eq_none))
    {
