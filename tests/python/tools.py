...
class Tool(object):
    ...
    def parse_output(self):
        ...
        self.parse_boolean(text, 'result'                     , r'LTSs are equal \(strong bisimilarity\)', 'LTSs are not equal \(strong bisimilarity\)')
        self.parse_boolean(text, 'result'                     , r'LTSs are branching bisimilar', 'LTSs are not branching bisimilar')
        self.parse_boolean(text, 'result'                     , r'LTSs are equal \(branching bisimilarity\)', 'LTSs are not equal \(branching bisimilarity\)')
        ...
        self.parse_boolean(text, 'result'                     , r'LTSs are equal \(divergence preserving branching bisimilarity\)', 'LTSs are not equal \(divergence preserving branching bisimilarity\)')
        self.parse_boolean(text, 'result'                     , r'LTSs are weak bisimilar', 'LTSs are not weak bisimilar')
        self.parse_boolean(text, 'result'                     , r'LTSs are equal \(weak bisimilarity\)', 'LTSs are not equal \(weak bisimilarity\)')
        ...
        self.parse_boolean(text, 'result'                     , r'LTSs are equal \(divergence preserving weak bisimilarity\)', 'LTSs are not equal \(divergence preserving weak bisimilarity\)')
        self.parse_boolean(text, 'result'                     , r'LTSs are strongly simulation equivalent', 'LTSs are not strongly simulation equivalent')
        self.parse_boolean(text, 'result'                     , r'LTSs are equal \(strong simulation equivalence\)', 'LTSs are not equal \(strong simulation equivalence\)')
        self.parse_boolean(text, 'result'                     , r'LTSs are strongly trace equivalent', 'LTSs are not strongly trace equivalent')
        self.parse_boolean(text, 'result'                     , r'LTSs are equal \(strong trace equivalence\)', 'LTSs are not equal \(strong trace equivalence\)')
        self.parse_boolean(text, 'result'                     , r'LTSs are weak trace equivalent', 'LTSs are not weak trace equivalent')
        self.parse_boolean(text, 'result'                     , r'LTSs are equal \(weak trace equivalence\)', 'LTSs are not equal \(weak trace equivalence\)')
