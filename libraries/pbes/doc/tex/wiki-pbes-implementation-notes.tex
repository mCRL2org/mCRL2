...
%TCIDATA{LastRevised=Monday, December 12, 2011 13:16:02}
...
fresh identifier. The sort of $f_{1}$ may not contain any element of $%
...
f_{2}(x) & = & \left\{ 
\begin{array}{ll}
\{h_{s}(f_{1}(x))\}\text{ } & \text{if }s\in domain(\sigma _{S}\mathcal{)}
\\ 
