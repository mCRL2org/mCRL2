...
%TCIDATA{LastRevised=Friday, October 22, 2010 16:14:08}
...
\right. 
\end{equation*}%
and the function $\mathsf{inc:}$ $\mathbb{N}^{d}\times \mathbb{N}\rightarrow 
\mathbb{N}^{d}$ is defined inductively as%
\begin{equation*}
\left\{ 
\begin{array}{lll}
\mathsf{inc}(\alpha ,1) & = & \left\{ 
\begin{array}{ll}
\top  & \text{\textsf{if}}\ \alpha _{1}=\beta _{1} \\ 
\lbrack \alpha _{1}+1,\alpha _{2},\cdots ,\alpha _{d}] & \text{\textsf{%
otherwise}}%
\end{array}%
\right.  \\ 
&  &  \\ 
\mathsf{inc}(\alpha ,i+1) & = & \left\{ 
\begin{array}{ll}
\mathsf{inc}([\alpha _{1},\cdots ,\alpha _{i},0,\alpha _{i+2},\cdots ,\alpha
_{d}],i) & \text{\textsf{if}}\ \alpha _{i+1}=\beta _{i+1} \\ 
\lbrack \alpha _{1},\cdots ,\alpha _{i},\alpha _{i+1}+1,\alpha _{i+2},\cdots
...
_{j})_{m},0,\cdots ,0] & \text{\textsf{if}}\ \mathsf{rank}(X_{i})\text{ is
even} \\ 
\mathsf{inc}([(\mathcal{\alpha }_{j})_{1},\cdots ,(\mathcal{\alpha }%
_{j})_{m},0,\cdots ,0],m) & \text{\textsf{if}}\ \mathsf{rank}(X_{i})\text{
is odd}%
\end{array}%
\right. 
\end{equation*}%
