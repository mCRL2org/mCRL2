...
$\sigma \in \{ \mu, \nu \}$ a fixpoint symbol and $f$ a negation free formula
...
in the deprecated BES header?}
where $X \in \mc{X}$ is a proposition variable of type $\bool$ and $c \in \{ \true, \false \}$ is a Boolean constant.
\end{itemize}
\end{definition}
