...
struct aterm_traits<mcrl2::pbes_system::pbes_expression_with_variables >
{
  ...
  static void protect(mcrl2::pbes_system::pbes_expression_with_variables t)
  {
    t.protect();
    t.variables().protect();
  }
  static void unprotect(mcrl2::pbes_system::pbes_expression_with_variables t)
  {
    t.unprotect();
    t.variables().unprotect();
  }
  static void mark(mcrl2::pbes_system::pbes_expression_with_variables t)
  {
    t.mark();
    t.variables().mark();
  }
  static ATerm term(mcrl2::pbes_system::pbes_expression_with_variables t)
  {
    return t.term();
  }
  static ATerm* ptr(mcrl2::pbes_system::pbes_expression_with_variables& t)
  {
    return &t.term();
  }
};
