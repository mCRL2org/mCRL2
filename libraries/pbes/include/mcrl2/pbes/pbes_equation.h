  ...
  public:
    ...
    bool is_well_typed() const
    {
      ...
      if (old_data::detail::sequence_contains_duplicates(
             boost::make_transform_iterator(variable().parameters().begin(), old_data::detail::data_variable_name()),
             boost::make_transform_iterator(variable().parameters().end()  , old_data::detail::data_variable_name())
            )
         )
      {
      ...
      if (old_data::detail::sequences_do_overlap(
             boost::make_transform_iterator(variable().parameters().begin(), old_data::detail::data_variable_name()),
             boost::make_transform_iterator(variable().parameters().end()  , old_data::detail::data_variable_name()),
             boost::make_transform_iterator(qvisitor.variables.begin()     , old_data::detail::data_variable_name()),
             boost::make_transform_iterator(qvisitor.variables.end()       , old_data::detail::data_variable_name())
           )
         )
      {
