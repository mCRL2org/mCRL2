...
struct sat_traverser: public action_formulas::action_formula_traverser<Derived>
{
  ...
  {
    push(atermpp::down_cast<pbes_expression>(lps::equal_multi_actions(a, lps::multi_action(x.actions()))));
  }
  ...
  void apply(const action_formulas::forall& x)
  {
    ...
    tr::make_forall(result, y, Sat(a, action_formulas::replace_variables_capture_avoiding(alpha, sigma_x), id_generator, TermTraits()));
    push(result);
  }
  ...
  void apply(const action_formulas::exists& x)
  {
    ...
    pbes_expression result;
    tr::make_exists(result, y, Sat(a, action_formulas::replace_variables_capture_avoiding(alpha, sigma_x), id_generator, TermTraits()));
    push(result);
  }
  ...
  void apply(const action_formulas::at& x)
  {
    ...
    push(tr::and_(Sat(a, alpha, id_generator, TermTraits()), atermpp::down_cast<pbes_expression>(data::equal_to(t, u))));
  }
};
