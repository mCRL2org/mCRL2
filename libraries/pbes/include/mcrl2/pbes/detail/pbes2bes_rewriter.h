...
namespace detail {
  ...
  typedef data::mutable_map_substitution<data::variable, data::data_expression_with_variables> pbes2bes_substitution_function;
...
/*
      ...
      std::set<data::variable> v = find_free_variables(result);
      for (std::set<data::variable>::iterator j = v.begin(); j != v.end(); ++j)
      {
