...
{
  std::set<new_data::variable> variables;

  /// \brief Visit forall node
  /// \param e A PBES expression
  /// \param v A sequence of data variables
  /// \return The result of visiting the node
  bool visit_forall(const pbes_expression& e, const new_data::variable_list& v, const pbes_expression&)
  {
  ...
  /// \param v A sequence of data variables
  /// \return The result of visiting the node
  bool visit_exists(const pbes_expression& e, const new_data::variable_list& v, const pbes_expression&)
  {
    variables.insert(v.begin(), v.end());
    return stop_recursion;
  }
...
struct quantifier_name_clash_visitor: public pbes_expression_visitor<pbes_expression>
{
  ...
  bool result;
  new_data::variable name_clash; // if result is true, then this attribute contains the conflicting variable
  ...
  void push(const new_data::variable_list& variables)
  {
    if (result)
    {
      return;
