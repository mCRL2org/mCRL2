...
struct pbes_visitor
{
  ...
  /// Visit true node.
  ///
  virtual bool visit_true(const pbes_expression& e, Arg& /* a */)
  {
    return continue_recursion;
  }
  ...
  /// Visit false node.
  ///
  virtual bool visit_false(const pbes_expression& e, Arg& /* a */)
  {
    return continue_recursion;
  }
  ...
  /// Visit not node.
  ///
  virtual bool visit_not(const pbes_expression& e, const pbes_expression& /* arg */, Arg& /* a */)
  {
    return continue_recursion;
  }
  ...
  /// Visit and node.
  ///
  virtual bool visit_and(const pbes_expression& e, const pbes_expression& /* left */, const pbes_expression& /* right */, Arg& /* a */)
  {
    return continue_recursion;
  }
  ...
  /// Visit or node.
  ///
  virtual bool visit_or(const pbes_expression& e, const pbes_expression& /* left */, const pbes_expression& /* right */, Arg& /* a */)
  {
    return continue_recursion;
  }    
  ...
  /// Visit imp node.
  ///
  virtual bool visit_imp(const pbes_expression& e, const pbes_expression& /* left */, const pbes_expression& /* right */, Arg& /* a */)
  {
    return continue_recursion;
  }
  ...
  ///
  virtual bool visit_propositional_variable(const pbes_expression& e, const propositional_variable_instantiation& /* v */, Arg& /* a */)
  {
    return continue_recursion;
  }
  ...
  void visit(const pbes_expression& e, Arg& a)
  {
    using namespace pbes_expr_optimized;
    using namespace accessors;

    if (is_data(e)) {
      visit_data_expression(e, val(e), a);
      ...
      visit_propositional_variable(e, propositional_variable_instantiation(e), a);
...
/// must be overridden to add behavior. If the visit_<node> function returns true,
/// the recursion is continued in the children of the node.
// TODO: implement using pbes_visitor
