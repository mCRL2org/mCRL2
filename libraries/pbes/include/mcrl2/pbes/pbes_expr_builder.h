...
//
/// \file mcrl2/pbes/pbes_expr_builder.h
...
struct pbes_expr_builder
{
  ...
  {
    throw mcrl2::runtime_error(std::string("error in pbes_expr_builder::visit() : unknown pbes expression ") + to_string(e));
    return term_type();
  }
...
struct pbes_expr_builder<Term, void>
{
  /// \brief The type of the additional argument for the recursion
...
#endif // MCRL2_PBES_PBES_EXPR_BUILDER_H
