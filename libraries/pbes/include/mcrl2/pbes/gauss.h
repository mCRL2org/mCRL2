...
#include "mcrl2/new_data/rewriter.h" // rewriter
#include "mcrl2/new_data/detail/bdd_prover.h" // prover
...
class pbes_solver {
 private:
  ...
  bool pnf;
  new_data::detail::BDD_Prover* prover;
  pbes_system::pbes<> pbes_spec;
  ...
  pbes_system::pbes_equation solve_equation(pbes_system::pbes_equation e);
  ...
  void solve_equation_interactive(pbes_system::propositional_variable X,
				  pbes_system::pbes_expression defX,
				  pbes_system::pbes_expression approx);

 public:

  pbes_solver(pbes_system::pbes<> p_pbes_spec,
	      new_data::detail::SMT_Solver_Type solver,
	      new_data::detail::RewriteStrategy rew_strategy,
	      int p_bound, bool p_pnf, bool p_interactive);

  /// This function implements the Gauss elimination algorithm.
  atermpp::vector<pbes_system::pbes_equation> solve();
...
pbes_system::pbes_expression pbes_expression_prove
(pbes_system::pbes_expression e, new_data::detail::BDD_Prover* p);
...
pbes_system::pbes_expression pbes_expression_simplify
(pbes_system::pbes_expression p, int *nq, new_data::variable_list& fv , new_data::detail::BDD_Prover *prover);
...
new_data::data_expression data_expression_simplify
(new_data::data_expression d, new_data::variable_list& fv, new_data::detail::BDD_Prover *prover);
...
new_data::data_expression pbes_to_data(pbes_system::pbes_expression e);
...
pbes_system::pbes_expression data_to_pbes_lazy(new_data::data_expression d);


/// This translates as much as possible of the logical operators
/// to pbes operators. Unfinished.
pbes_system::pbes_expression data_to_pbes_greedy(new_data::data_expression d);


/// Returns expr [X <- solX].
pbes_system::pbes_expression substitute(pbes_system::pbes_expression expr,
			   pbes_system::propositional_variable X,
			   pbes_system::pbes_expression solX);


/// Substitutes, in e, all predicate variables with their respective
/// solutions as given by es_solution.
pbes_system::pbes_expression update_expression(pbes_system::pbes_expression e,
				  atermpp::vector<pbes_system::pbes_equation> es_solution);
...
pbes_system::pbes_expression enumerate_finite_domains
(bool forall, new_data::variable_list &quant_vars, pbes_system::pbes_expression p, new_data::detail::BDD_Prover *prover);


/// Compares two pbes expressions using the prover.
/// It only works for quantifier-free expressions.
bool pbes_expression_compare
(pbes_system::pbes_expression p, pbes_system::pbes_expression q, new_data::detail::BDD_Prover* prover);
