...
{
  protected:
    pbes<Container> type_checked_pbes_spec;
  ...
  public:
    pbes_type_checker(const pbes<Container>& pbes_spec)
...
{
  pbes_type_checker<Container> type_checker(pbes_spec);
  try
  {
