...
//
/// \file mcrl2/pbes/pbes_output_tool.h
/// \brief Base class for tools that produce a (P)BES as output.

#ifndef MCRL2_PBES_PBES_OUTPUT_TOOL_H
#define MCRL2_PBES_PBES_OUTPUT_TOOL_H
...
class pbes_output_tool: public Tool
{
  protected:
    ...
    virtual std::set<utilities::file_format> available_output_formats() const
    {
      ...
      result.insert(pbes_system::pbes_format_internal_bes());
    ...
    void parse_options(const utilities::command_line_parser& parser) override
    {
      ...
      if (m_pbes_output_format == utilities::file_format())
      {
        ...
        mCRL2log(log::log_level_t::verbose) << "Guessing output format: " << m_pbes_output_format.description()
                               << std::endl;
      }
    }
