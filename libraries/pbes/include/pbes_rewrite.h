...
mcrl2::pbes_system::pbes_expression pbes_expression_rewrite(mcrl2::pbes_system::pbes_expression p, mcrl2::data::data_specification data, mcrl2::data::detail::Rewriter *rewriter);
...
mcrl2::pbes_system::pbes_expression_list get_all_possible_expressions(mcrl2::data::variable_list data_vars, mcrl2::pbes_system::pbes_expression pbexp, mcrl2::data::data_specification data);
...
mcrl2::pbes_system::pbes_expression_list get_and_expressions(mcrl2::pbes_system::pbes_expression_list and_list, mcrl2::data::data_specification data, mcrl2::data::detail::Rewriter *rewriter);
...
mcrl2::pbes_system::pbes_expression_list get_or_expressions(mcrl2::pbes_system::pbes_expression_list or_list, mcrl2::data::data_specification data, mcrl2::data::detail::Rewriter *rewriter);
