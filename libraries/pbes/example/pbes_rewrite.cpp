...
typedef old_data::data_enumerator<old_data::rewriter, number_postfix_generator> my_enumerator;
typedef simplify_rewriter<old_data::rewriter> my_simplify_rewriter;
typedef enumerate_quantifiers_rewriter<old_data::rewriter, my_enumerator> my_enumerate_quantifiers_rewriter;
...
old_data::rewriter::strategy data_rewriter_strategy(int i)
{
  switch (i)
  {
    case 0: return old_data::rewriter::innermost       ;
    case 1: return old_data::rewriter::innermost_prover;
    case 2: return old_data::rewriter::jitty           ;
    case 3: return old_data::rewriter::jitty_prover    ;
  }
  return old_data::rewriter::jitty_prover;
}
...
int main(int argc, char* argv[])
{
  ...
  try {
    ...
    std::vector<old_data::rewriter> data_rewriters;
    ...
    for (std::vector<int>::iterator i = data_rewriter_indices.begin(); i != data_rewriter_indices.end(); ++i)
    {
      ...
      data_rewriters.push_back(old_data::rewriter(data_spec, data_rewriter_strategy(*i)));
      old_data::rewriter& datar = data_rewriters.back();
