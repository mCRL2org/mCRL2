...
namespace mcrl2::data::sort_nat
{
      ...
      data_equation_vector nat_generate_equations_code()
      {
        ...
        result.emplace_back(variable_list({vp}), equal_to(c0(), cnat(vp)), sort_bool::false_());
        result.emplace_back(variable_list({vp}), equal_to(cnat(vp), c0()), sort_bool::false_());
        result.emplace_back(variable_list({vp, vq}), equal_to(cnat(vp), cnat(vq)), equal_to(vp, vq));
        ...
        result.emplace_back(variable_list({vp}), pos2nat(vp), cnat(vp));
        result.emplace_back(variable_list({vp}), nat2pos(cnat(vp)), vp);
        result.emplace_back(variable_list({vp}), maximum(vp, c0()), vp);
        result.emplace_back(variable_list({vp, vq}), maximum(vp, cnat(vq)), if_(less_equal(vp, vq), vq, vp));
        result.emplace_back(variable_list({vp}), maximum(c0(), vp), vp);
        result.emplace_back(variable_list({vp, vq}), maximum(cnat(vp), vq), if_(less_equal(vp, vq), vq, vp));
        ...
        result.emplace_back(variable_list(), succ(c0()), sort_pos::c1());
        ...
        result.emplace_back(variable_list(), dub(sort_bool::true_(), c0()), cnat(sort_pos::c1()));
        result.emplace_back(variable_list({vb, vp}), dub(vb, cnat(vp)), cnat(sort_pos::cdub(vb, vp)));
        result.emplace_back(variable_list({vp}), plus(vp, c0()), vp);
        result.emplace_back(variable_list({vp, vq}), plus(vp, cnat(vq)), sort_pos::add_with_carry(sort_bool::false_(), vp, vq));
        result.emplace_back(variable_list({vp}), plus(c0(), vp), vp);
        result.emplace_back(variable_list({vp, vq}), plus(cnat(vp), vq), sort_pos::add_with_carry(sort_bool::false_(), vp, vq));
        ...
        result.emplace_back(variable_list({vp}), exp(vp, c0()), sort_pos::c1());
        result.emplace_back(variable_list({vp}), exp(vp, cnat(sort_pos::c1())), vp);
        result.emplace_back(variable_list({vp, vq}), exp(vp, cnat(sort_pos::cdub(sort_bool::false_(), vq))), exp(times(vp, vp), cnat(vq)));
        result.emplace_back(variable_list({vp, vq}), exp(vp, cnat(sort_pos::cdub(sort_bool::true_(), vq))), times(vp, exp(times(vp, vp), cnat(vq))));
        result.emplace_back(variable_list({vn}), exp(vn, c0()), cnat(sort_pos::c1()));
        result.emplace_back(variable_list({vp}), exp(c0(), cnat(vp)), c0());
        result.emplace_back(variable_list({vn, vp}), exp(cnat(vp), vn), cnat(exp(vp, vn)));
        result.emplace_back(variable_list(), even(c0()), sort_bool::true_());
        result.emplace_back(variable_list(), even(cnat(sort_pos::c1())), sort_bool::false_());
        result.emplace_back(variable_list({vb, vp}), even(cnat(sort_pos::cdub(vb, vp))), sort_bool::not_(vb));
        result.emplace_back(variable_list({vp}), div(c0(), vp), c0());
        result.emplace_back(variable_list({vp, vq}), div(cnat(vp), vq), first(divmod(vp, vq)));
        result.emplace_back(variable_list({vp}), mod(c0(), vp), c0());
        ...
        result.emplace_back(variable_list({vp, vq}), not_equal_to(vp, vq), swap_zero(cnat(vp), cnat(vq)), cnat(vq));
        result.emplace_back(variable_list({vm, vn}), swap_zero_add(c0(), c0(), vm, vn), plus(vm, vn));
        result.emplace_back(variable_list({vm, vp}), swap_zero_add(cnat(vp), c0(), vm, c0()), vm);
        result.emplace_back(variable_list({vm, vp, vq}), swap_zero_add(cnat(vp), c0(), vm, cnat(vq)), swap_zero(cnat(vp), plus(swap_zero(cnat(vp), vm), cnat(vq))));
        result.emplace_back(variable_list({vn, vp}), swap_zero_add(c0(), cnat(vp), c0(), vn), vn);
        result.emplace_back(variable_list({vn, vp, vq}), swap_zero_add(c0(), cnat(vp), cnat(vq), vn), swap_zero(cnat(vp), plus(cnat(vq), swap_zero(cnat(vp), vn))));
        result.emplace_back(variable_list({vm, vn, vp, vq}), swap_zero_add(cnat(vp), cnat(vq), vm, vn), swap_zero(plus(cnat(vp), cnat(vq)), plus(swap_zero(cnat(vp), vm), swap_zero(cnat(vq), vn))));
        result.emplace_back(variable_list({vm, vn}), swap_zero_min(c0(), c0(), vm, vn), minimum(vm, vn));
        result.emplace_back(variable_list({vm, vp}), swap_zero_min(cnat(vp), c0(), vm, c0()), c0());
        result.emplace_back(variable_list({vm, vp, vq}), swap_zero_min(cnat(vp), c0(), vm, cnat(vq)), minimum(swap_zero(cnat(vp), vm), cnat(vq)));
        result.emplace_back(variable_list({vn, vp}), swap_zero_min(c0(), cnat(vp), c0(), vn), c0());
        result.emplace_back(variable_list({vn, vp, vq}), swap_zero_min(c0(), cnat(vp), cnat(vq), vn), minimum(cnat(vq), swap_zero(cnat(vp), vn)));
        result.emplace_back(variable_list({vm, vn, vp, vq}), swap_zero_min(cnat(vp), cnat(vq), vm, vn), swap_zero(minimum(cnat(vp), cnat(vq)), minimum(swap_zero(cnat(vp), vm), swap_zero(cnat(vq), vn))));
        result.emplace_back(variable_list({vm, vn}), swap_zero_monus(c0(), c0(), vm, vn), monus(vm, vn));
        result.emplace_back(variable_list({vm, vp}), swap_zero_monus(cnat(vp), c0(), vm, c0()), vm);
        result.emplace_back(variable_list({vm, vp, vq}), swap_zero_monus(cnat(vp), c0(), vm, cnat(vq)), swap_zero(cnat(vp), monus(swap_zero(cnat(vp), vm), cnat(vq))));
        result.emplace_back(variable_list({vn, vp}), swap_zero_monus(c0(), cnat(vp), c0(), vn), c0());
        result.emplace_back(variable_list({vn, vp, vq}), swap_zero_monus(c0(), cnat(vp), cnat(vq), vn), monus(cnat(vq), swap_zero(cnat(vp), vn)));
        result.emplace_back(variable_list({vm, vn, vp, vq}), swap_zero_monus(cnat(vp), cnat(vq), vm, vn), swap_zero(monus(cnat(vp), cnat(vq)), monus(swap_zero(cnat(vp), vm), swap_zero(cnat(vq), vn))));
        result.emplace_back(variable_list(), sqrt(c0()), c0());
        result.emplace_back(variable_list({vp}), sqrt(cnat(vp)), sqrt_nat_aux_func(cnat(vp), c0(), sort_pos::powerlog2_pos(vp)));
        result.emplace_back(variable_list({vm, vn}), sqrt_nat_aux_func(vn, vm, sort_pos::c1()), if_(less_equal(vn, vm), c0(), cnat(sort_pos::c1())));
        ...
        result.emplace_back(variable_list({vm, vn, vu, vv}), equal_to(cpair(vm, vn), cpair(vu, vv)), sort_bool::and_(equal_to(vm, vu), equal_to(vn, vv)));
        result.emplace_back(variable_list({vm, vn, vu, vv}), less(cpair(vm, vn), cpair(vu, vv)), sort_bool::or_(less(vm, vu), sort_bool::and_(equal_to(vm, vu), less(vn, vv))));
        result.emplace_back(variable_list({vm, vn, vu, vv}), less_equal(cpair(vm, vn), cpair(vu, vv)), sort_bool::or_(less(vm, vu), sort_bool::and_(equal_to(vm, vu), less_equal(vn, vv))));
        result.emplace_back(variable_list({vm, vn}), first(cpair(vm, vn)), vm);
        result.emplace_back(variable_list({vm, vn}), last(cpair(vm, vn)), vn);
        result.emplace_back(variable_list(), divmod(sort_pos::c1(), sort_pos::c1()), cpair(cnat(sort_pos::c1()), c0()));
        result.emplace_back(variable_list({vb, vp}), divmod(sort_pos::c1(), sort_pos::cdub(vb, vp)), cpair(c0(), cnat(sort_pos::c1())));
        result.emplace_back(variable_list({vb, vp, vq}), divmod(sort_pos::cdub(vb, vp), vq), generalised_divmod(divmod(vp, vq), vb, vq));
