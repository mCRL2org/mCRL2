...
namespace mcrl2 {
  ...
  namespace data {
    ...
    namespace sort_fbag {
      ...
      /// \brief Constructor for function symbol \@fbag_insert.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol \@fbag_insert.       /// \param s A sort expression. 
      ...
      /// \brief Constructor for function symbol \@fbag_cons.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol \@fbag_cons.       /// \param s A sort expression. 
      /// \param arg0 A data expression.
      /// \param arg1 A data expression.
      /// \param arg2 A data expression. 
      ...
      /// \brief Constructor for function symbol \@fbag_cinsert.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol \@fbag_cinsert.       /// \param s A sort expression. 
      /// \param arg0 A data expression.
      /// \param arg1 A data expression.
      /// \param arg2 A data expression. 
      ...
      /// \brief Constructor for function symbol count.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol count.       /// \param s A sort expression. 
      /// \param arg0 A data expression.
      /// \param arg1 A data expression. 
      ...
      /// \brief Constructor for function symbol in.       /// \param s A sort expression.
      ...
      /// \brief Constructor for function symbol \@fbag_join.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol \@fbag_join.       /// \param s A sort expression. 
      /// \param arg0 A data expression.
      /// \param arg1 A data expression.
      /// \param arg2 A data expression.
      ...
      /// \brief Constructor for function symbol \@fbag_inter.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol \@fbag_inter.       /// \param s A sort expression. 
      /// \param arg0 A data expression.
      /// \param arg1 A data expression.
      /// \param arg2 A data expression.
      /// \param arg3 A data expression. 
      ...
      /// \brief Constructor for function symbol \@fbag_diff.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol \@fbag_diff.       /// \param s A sort expression. 
      /// \param arg0 A data expression.
      /// \param arg1 A data expression.
      /// \param arg2 A data expression.
      /// \param arg3 A data expression. 
      ...
      /// \brief Constructor for function symbol \@fbag2fset.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol \@fbag2fset.       /// \param s A sort expression. 
      /// \param arg0 A data expression.
      /// \param arg1 A data expression. 
      ...
      /// \brief Constructor for function symbol \@fset2fbag.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol \@fset2fbag.       /// \param s A sort expression. 
      /// \param arg0 A data expression. 
      ...
      data_equation_vector fbag_generate_equations_code(const sort_expression& s)
      {
        ...
        result.push_back(data_equation(variable_list({v@cNat, vb, vd, vp}), cinsert(s, vd, v@cNat(vp), vb), insert(s, vd, vp, vb)));
        result.push_back(data_equation(variable_list({vd}), count(s, vd, empty(s)), sort_nat::c0()));
        result.push_back(data_equation(variable_list({v@cNat, vb, vd, vp}), count(s, vd, cons_(s, vd, vp, vb)), v@cNat(vp)));
        ...
        result.push_back(data_equation(variable_list({vf, vg}), join(s, vf, vg, empty(s), empty(s)), empty(s)));
        result.push_back(data_equation(variable_list({v@cNat, vb, vd, vf, vg, vp}), join(s, vf, vg, cons_(s, vd, vp, vb), empty(s)), cinsert(s, vd, sort_nat::swap_zero_add(vf(vd), vg(vd), v@cNat(vp), sort_nat::c0()), join(s, vf, vg, vb, empty(s)))));
        result.push_back(data_equation(variable_list({v@cNat, vc, ve, vf, vg, vq}), join(s, vf, vg, empty(s), cons_(s, ve, vq, vc)), cinsert(s, ve, sort_nat::swap_zero_add(vf(ve), vg(ve), sort_nat::c0(), v@cNat(vq)), join(s, vf, vg, empty(s), vc))));
        result.push_back(data_equation(variable_list({v@cNat, vb, vc, vd, vf, vg, vp, vq}), join(s, vf, vg, cons_(s, vd, vp, vb), cons_(s, vd, vq, vc)), cinsert(s, vd, sort_nat::swap_zero_add(vf(vd), vg(vd), v@cNat(vp), v@cNat(vq)), join(s, vf, vg, vb, vc))));
        result.push_back(data_equation(variable_list({v@cNat, vb, vc, vd, ve, vf, vg, vp, vq}), less(vd, ve), join(s, vf, vg, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), cinsert(s, vd, sort_nat::swap_zero_add(vf(vd), vg(vd), v@cNat(vp), sort_nat::c0()), join(s, vf, vg, vb, cons_(s, ve, vq, vc)))));
        result.push_back(data_equation(variable_list({v@cNat, vb, vc, vd, ve, vf, vg, vp, vq}), less(ve, vd), join(s, vf, vg, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), cinsert(s, ve, sort_nat::swap_zero_add(vf(ve), vg(ve), sort_nat::c0(), v@cNat(vq)), join(s, vf, vg, cons_(s, vd, vp, vb), vc))));
        result.push_back(data_equation(variable_list({vf, vg}), fbag_intersect(s, vf, vg, empty(s), empty(s)), empty(s)));
        result.push_back(data_equation(variable_list({v@cNat, vb, vd, vf, vg, vp}), fbag_intersect(s, vf, vg, cons_(s, vd, vp, vb), empty(s)), cinsert(s, vd, sort_nat::swap_zero_min(vf(vd), vg(vd), v@cNat(vp), sort_nat::c0()), fbag_intersect(s, vf, vg, vb, empty(s)))));
        result.push_back(data_equation(variable_list({v@cNat, vc, ve, vf, vg, vq}), fbag_intersect(s, vf, vg, empty(s), cons_(s, ve, vq, vc)), cinsert(s, ve, sort_nat::swap_zero_min(vf(ve), vg(ve), sort_nat::c0(), v@cNat(vq)), fbag_intersect(s, vf, vg, empty(s), vc))));
        result.push_back(data_equation(variable_list({v@cNat, vb, vc, vd, vf, vg, vp, vq}), fbag_intersect(s, vf, vg, cons_(s, vd, vp, vb), cons_(s, vd, vq, vc)), cinsert(s, vd, sort_nat::swap_zero_min(vf(vd), vg(vd), v@cNat(vp), v@cNat(vq)), fbag_intersect(s, vf, vg, vb, vc))));
        result.push_back(data_equation(variable_list({v@cNat, vb, vc, vd, ve, vf, vg, vp, vq}), less(vd, ve), fbag_intersect(s, vf, vg, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), cinsert(s, vd, sort_nat::swap_zero_min(vf(vd), vg(vd), v@cNat(vp), sort_nat::c0()), fbag_intersect(s, vf, vg, vb, cons_(s, ve, vq, vc)))));
        result.push_back(data_equation(variable_list({v@cNat, vb, vc, vd, ve, vf, vg, vp, vq}), less(ve, vd), fbag_intersect(s, vf, vg, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), cinsert(s, ve, sort_nat::swap_zero_min(vf(ve), vg(ve), sort_nat::c0(), v@cNat(vq)), fbag_intersect(s, vf, vg, cons_(s, vd, vp, vb), vc))));
        result.push_back(data_equation(variable_list({vf, vg}), fbag_difference(s, vf, vg, empty(s), empty(s)), empty(s)));
        result.push_back(data_equation(variable_list({v@cNat, vb, vd, vf, vg, vp}), fbag_difference(s, vf, vg, cons_(s, vd, vp, vb), empty(s)), cinsert(s, vd, sort_nat::swap_zero_monus(vf(vd), vg(vd), v@cNat(vp), sort_nat::c0()), fbag_difference(s, vf, vg, vb, empty(s)))));
        result.push_back(data_equation(variable_list({v@cNat, vc, ve, vf, vg, vq}), fbag_difference(s, vf, vg, empty(s), cons_(s, ve, vq, vc)), cinsert(s, ve, sort_nat::swap_zero_monus(vf(ve), vg(ve), sort_nat::c0(), v@cNat(vq)), fbag_difference(s, vf, vg, empty(s), vc))));
        result.push_back(data_equation(variable_list({v@cNat, vb, vc, vd, vf, vg, vp, vq}), fbag_difference(s, vf, vg, cons_(s, vd, vp, vb), cons_(s, vd, vq, vc)), cinsert(s, vd, sort_nat::swap_zero_monus(vf(vd), vg(vd), v@cNat(vp), v@cNat(vq)), fbag_difference(s, vf, vg, vb, vc))));
        result.push_back(data_equation(variable_list({v@cNat, vb, vc, vd, ve, vf, vg, vp, vq}), less(vd, ve), fbag_difference(s, vf, vg, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), cinsert(s, vd, sort_nat::swap_zero_monus(vf(vd), vg(vd), v@cNat(vp), sort_nat::c0()), fbag_difference(s, vf, vg, vb, cons_(s, ve, vq, vc)))));
        result.push_back(data_equation(variable_list({v@cNat, vb, vc, vd, ve, vf, vg, vp, vq}), less(ve, vd), fbag_difference(s, vf, vg, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), cinsert(s, ve, sort_nat::swap_zero_monus(vf(ve), vg(ve), sort_nat::c0(), v@cNat(vq)), fbag_difference(s, vf, vg, cons_(s, vd, vp, vb), vc))));
        result.push_back(data_equation(variable_list({vf}), fbag2fset(s, vf, empty(s)), sort_fset::empty(s)));
        result.push_back(data_equation(variable_list({v@cNat, vb, vd, vf, vp}), fbag2fset(s, vf, cons_(s, vd, vp, vb)), sort_fset::cinsert(s, vd, equal_to(equal_to(vf(vd), v@cNat(vp)), greater(vf(vd), sort_nat::c0())), fbag2fset(s, vf, vb))));
        result.push_back(data_equation(variable_list(), fset2fbag(s, sort_fset::empty(s)), empty(s)));
        result.push_back(data_equation(variable_list({v@cNat, vd, vs}), fset2fbag(s, sort_fset::cons_(s, vd, vs)), cinsert(s, vd, v@cNat(sort_pos::c1()), fset2fbag(s, vs))));
        ...
        result.push_back(data_equation(variable_list({v@cNat, vd, vp}), count_all(s, cons_(s, vd, vp, empty(s))), v@cNat(vp)));
        result.push_back(data_equation(variable_list({v@cNat, vb, vd, ve, vp, vq}), count_all(s, cons_(s, vd, vp, cons_(s, ve, vq, vb))), v@cNat(sort_pos::add_with_carry(sort_bool::false_(), vp, sort_nat::nat2pos(count_all(s, cons_(s, ve, vq, vb)))))));
        return result;
      }
