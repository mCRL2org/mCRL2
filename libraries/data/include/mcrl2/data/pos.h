  ...
  namespace data {
    ...
    namespace sort_pos {
      ...
      bool is_c1_function_symbol(const data_expression& e)
      {
        ...
        {
          return static_cast< function_symbol >(e).name() == "@c1";
        }
        return false;
      }
      ...
      bool is_cdub_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast< function_symbol >(e).name() == "@cDub";
        }
        return false;
      }
      ...
      bool is_add_with_carry_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast< function_symbol >(e).name() == "@addc";
        }
        return false;
      }
      ...
      bool is_multir_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast< function_symbol >(e).name() == "@multir";
        }
        return false;
      }
