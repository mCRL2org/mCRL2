...
struct add_sort_expressions: public Builder<Derived>
{
  ...
  data::data_expression operator()(const data::data_expression& x)
  {
    ...
    {
      result = static_cast<Derived&>(*this)(data::abstraction(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_identifier(x))
    {
      result = static_cast<Derived&>(*this)(data::identifier(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_variable(x))
    {
      result = static_cast<Derived&>(*this)(data::variable(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_function_symbol(x))
    {
      result = static_cast<Derived&>(*this)(data::function_symbol(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_application(x))
    {
      result = static_cast<Derived&>(*this)(data::application(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_where_clause(x))
    {
      result = static_cast<Derived&>(*this)(data::where_clause(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
    return result;
  }
  ...
  data::assignment_expression operator()(const data::assignment_expression& x)
  {
    ...
    {
      result = static_cast<Derived&>(*this)(data::assignment(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_identifier_assignment(x))
    {
      result = static_cast<Derived&>(*this)(data::identifier_assignment(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
    return result;
  }
  ...
  data::sort_expression operator()(const data::sort_expression& x)
  {
    ...
    {
      result = static_cast<Derived&>(*this)(data::basic_sort(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_container_sort(x))
    {
      result = static_cast<Derived&>(*this)(data::container_sort(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_structured_sort(x))
    {
      result = static_cast<Derived&>(*this)(data::structured_sort(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_function_sort(x))
    {
      result = static_cast<Derived&>(*this)(data::function_sort(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_unknown_sort(x))
    {
      result = static_cast<Derived&>(*this)(data::unknown_sort(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_multiple_possible_sorts(x))
    {
      result = static_cast<Derived&>(*this)(data::multiple_possible_sorts(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
    return result;
  }
  ...
  data::data_expression operator()(const data::abstraction& x)
  {
    ...
    if (data::is_forall(x))
    {
      result = static_cast<Derived&>(*this)(data::forall(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_exists(x))
    {
      result = static_cast<Derived&>(*this)(data::exists(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    else if (data::is_lambda(x))
    {
      result = static_cast<Derived&>(*this)(data::lambda(atermpp::aterm_cast<atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
    return result;
  }
