...
#ifndef MCRL2_DATA_FSET64_H
#define MCRL2_DATA_FSET64_H
...
namespace mcrl2::data::sort_fset
{
      ...
      data_equation_vector fset_generate_equations_code(const sort_expression& s)
      {
        ...
        result.emplace_back(variable_list({vd, vs}), count(s, cons_(s, vd, vs)), sort_nat::succ_nat(count(s, vs)));
