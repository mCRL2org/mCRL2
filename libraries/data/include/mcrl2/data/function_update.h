...
namespace mcrl2 {
  ...
  namespace data {
      ...
      /// \brief Constructor for function symbol \@func_update.       /// \param s A sort expression.
      ...
      /// \brief Application of the function symbol \@func_update.       /// \param s A sort expression.
      /// \param t A sort expression. 
