  ...
  namespace data {
    ...
    namespace sort_nat {
      ...
      bool is_c0_function_symbol(const data_expression& e)
      {
        ...
        {
          return static_cast<const function_symbol&>(e) == c0();
        }
        return false;
      }
      ...
      // Application of @c0
      inline
      application c0(const data_expression& arg0)
      {
        assert(is_nat(arg0.sort()));
        
        return application(c0(),arg0);
      }

      // Recogniser for application of @c0
      inline
      bool is_c0_application(const data_expression& e)
      {
        if (e.is_application())
        {
          return is_c0_function_symbol(static_cast<const application&>(e).head());
        }
        return false;
      }
      ...
      bool is_cnat_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast<const function_symbol&>(e) == cnat();
        }
        return false;
      }
      ...
      bool is_cpair_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast<const function_symbol&>(e) == cpair();
        }
        return false;
      }
      ...
      bool is_pos2nat_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast<const function_symbol&>(e) == pos2nat();
        }
        return false;
      }
      ...
      bool is_nat2pos_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast<const function_symbol&>(e) == nat2pos();
        }
        return false;
      }
      ...
      bool is_gtesubt_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast<const function_symbol&>(e) == gtesubt();
        }
        return false;
      }
      ...
      bool is_even_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast<const function_symbol&>(e) == even();
        }
        return false;
      }
      ...
      bool is_first_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast<const function_symbol&>(e) == first();
        }
        return false;
      }
      ...
      bool is_last_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast<const function_symbol&>(e) == last();
        }
        return false;
      }
      ...
      bool is_divmod_function_symbol(const data_expression& e)
      {
        if (e.is_function_symbol())
        {
          return static_cast<const function_symbol&>(e) == divmod();
        }
        return false;
      }
