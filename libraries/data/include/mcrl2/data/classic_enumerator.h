...
namespace mcrl2 {
  namespace data {
    ...
    template < typename MutableSubstitution = mutable_associative_container_substitution< >,
    ...
    **/
    ...
    classic_enumerator< mutable_associative_container_substitution< >, void, selectors::select_all >
    make_simple_classic_enumerator(data_specification const& specification, VariableSequence const& variables)
    {
      return classic_enumerator< mutable_associative_container_substitution< >, void, selectors::select_all >(specification, variables);
    }
