...
namespace mcrl2::data::sort_fbag
{
      ...
      /// \param[out] result The data expression where the \@fbag_insert expression is put.
      /// \param[in] s A sort expression.
      /// \param[in] arg0 A data expression.
      /// \param[in] arg1 A data expression.
      /// \param[in] arg2 A data expression.
      ...
      /// \param[out] result The data expression where the \@fbag_cons expression is put.
      /// \param[in] s A sort expression.
      /// \param[in] arg0 A data expression.
      /// \param[in] arg1 A data expression.
      /// \param[in] arg2 A data expression.
      inline
      void make_cons(data_expression& result, const sort_expression& s, const data_expression& arg0, const data_expression& arg1, const data_expression& arg2)
      {
      ...
      /// \param[out] result The data expression where the \@fbag_cinsert expression is put.
      /// \param[in] s A sort expression.
      /// \param[in] arg0 A data expression.
      /// \param[in] arg1 A data expression.
      /// \param[in] arg2 A data expression.
      ...
      /// \param[out] result The data expression where the pick expression is put.
      /// \param[in] s A sort expression.
      /// \param[in] arg0 A data expression.
      inline
      ...
      data_equation_vector fbag_generate_equations_code(const sort_expression& s)
      {
        ...
        result.emplace_back(variable_list({vb, vd, vp}), less_total(empty(s), cons_(s, vd, vp, vb)), sort_bool::true_());
        result.emplace_back(variable_list({vb, vd, vp}), less_total(cons_(s, vd, vp, vb), empty(s)), sort_bool::false_());
        result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}), less_total(cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), sort_bool::or_(less_total(vd, ve), sort_bool::or_(sort_bool::and_(equal_to(vd, ve), less_total(vp, vq)), sort_bool::and_(equal_to(vd, ve), sort_bool::and_(equal_to(vp, vq), less_total(vb, vc))))));
        result.emplace_back(variable_list({vd, vp}), insert(s, vd, vp, empty(s)), cons_(s, vd, vp, empty(s)));
        result.emplace_back(variable_list({vb, vd, vp, vq}), insert(s, vd, vp, cons_(s, vd, vq, vb)), cons_(s, vd, sort_pos::auxiliary_plus_pos(vp, vq), vb));
        result.emplace_back(variable_list({vb, vd, ve, vp, vq}), less_total(vd, ve), insert(s, vd, vp, cons_(s, ve, vq, vb)), cons_(s, vd, vp, cons_(s, ve, vq, vb)));
        result.emplace_back(variable_list({vb, vd, ve, vp, vq}), less_total(ve, vd), insert(s, vd, vp, cons_(s, ve, vq, vb)), cons_(s, ve, vq, insert(s, vd, vp, vb)));
        result.emplace_back(variable_list({vb, vd, vn}), cinsert(s, vd, vn, vb), if_(equal_to(vn, sort_nat::most_significant_digit_nat(sort_machine_word::zero_word())), vb, insert(s, vd, sort_nat::nat2pos(vn), vb)));
        result.emplace_back(variable_list({vd}), count(s, vd, empty(s)), sort_nat::c0());
        result.emplace_back(variable_list({vb, vd, vp}), count(s, vd, cons_(s, vd, vp, vb)), sort_nat::pos2nat(vp));
        result.emplace_back(variable_list({vb, vd, ve, vp}), less_total(vd, ve), count(s, vd, cons_(s, ve, vp, vb)), sort_nat::c0());
        result.emplace_back(variable_list({vb, vd, ve, vp}), less_total(ve, vd), count(s, vd, cons_(s, ve, vp, vb)), count(s, vd, vb));
        ...
        result.emplace_back(variable_list({vb, vc, vd, vp, vq}), less_total(vq, vp), difference(s, cons_(s, vd, vp, vb), cons_(s, vd, vq, vc)), cons_(s, vd, sort_nat::nat2pos(sort_nat::monus(sort_nat::pos2nat(vp), sort_nat::pos2nat(vq))), difference(s, vb, vc)));
        ...
        result.emplace_back(variable_list({vb, vc, vd, vp, vq}), union_(s, cons_(s, vd, vp, vb), cons_(s, vd, vq, vc)), cons_(s, vd, sort_pos::auxiliary_plus_pos(vp, vq), union_(s, vb, vc)));
        result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}), less_total(vd, ve), union_(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), cons_(s, vd, vp, union_(s, vb, cons_(s, ve, vq, vc))));
        result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}), less_total(ve, vd), union_(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), cons_(s, ve, vq, union_(s, cons_(s, vd, vp, vb), vc)));
        ...
        result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}), less_total(vd, ve), intersection(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), intersection(s, vb, cons_(s, ve, vq, vc)));
        result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}), less_total(ve, vd), intersection(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)), intersection(s, cons_(s, vd, vp, vb), vc));
        result.emplace_back(variable_list(), count_all(s, empty(s)), sort_nat::c0());
        result.emplace_back(variable_list({vd, vp}), count_all(s, cons_(s, vd, vp, empty(s))), sort_nat::pos2nat(vp));
        result.emplace_back(variable_list({vb, vd, ve, vp, vq}), count_all(s, cons_(s, vd, vp, cons_(s, ve, vq, vb))), sort_nat::pos2nat(sort_pos::auxiliary_plus_pos(vp, sort_nat::nat2pos(count_all(s, cons_(s, ve, vq, vb))))));
