...
namespace mcrl2::data::sort_fbag {
  ...
  data_equation_vector fbag_generate_equations_code(const sort_expression& s)
  {
    ...
    result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}),
        equal_to(cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)),
        sort_bool::and_(equal_to(vp, vq), sort_bool::and_(equal_to(vd, ve), equal_to(vb, vc))));
    ...
    result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}),
        less_equal(cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)),
        if_(less(vd, ve),
            sort_bool::false_(),
            if_(equal_to(vd, ve),
                sort_bool::and_(less_equal(vp, vq), less_equal(vb, vc)),
                less_equal(cons_(s, vd, vp, vb), vc))));
    ...
    result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}),
        less(cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)),
        if_(less(vd, ve),
            sort_bool::false_(),
            if_(equal_to(vd, ve),
                sort_bool::or_(sort_bool::and_(equal_to(vp, vq), less(vb, vc)),
                    sort_bool::and_(less(vp, vq), less_equal(vb, vc))),
                less_equal(cons_(s, vd, vp, vb), vc))));
    result.emplace_back(variable_list({vd, vp}), insert(s, vd, vp, empty(s)), cons_(s, vd, vp, empty(s)));
    result.emplace_back(variable_list({vb, vd, vp, vq}),
        insert(s, vd, vp, cons_(s, vd, vq, vb)),
        cons_(s, vd, sort_pos::auxiliary_plus_pos(vp, vq), vb));
    result.emplace_back(variable_list({vb, vd, ve, vp, vq}),
        less(vd, ve),
        insert(s, vd, vp, cons_(s, ve, vq, vb)),
        cons_(s, vd, vp, cons_(s, ve, vq, vb)));
    result.emplace_back(variable_list({vb, vd, ve, vp, vq}),
        less(ve, vd),
        insert(s, vd, vp, cons_(s, ve, vq, vb)),
        cons_(s, ve, vq, insert(s, vd, vp, vb)));
    result.emplace_back(variable_list({vb, vd, vn}),
        cinsert(s, vd, vn, vb),
        if_(equal_to(vn, sort_nat::most_significant_digit_nat(sort_machine_word::zero_word())),
            vb,
            insert(s, vd, sort_nat::nat2pos(vn), vb)));
    ...
    result.emplace_back(variable_list({vb, vd, ve, vp}),
        less(vd, ve),
        count(s, vd, cons_(s, ve, vp, vb)),
        sort_nat::c0());
    result.emplace_back(variable_list({vb, vd, ve, vp}),
        less(ve, vd),
        count(s, vd, cons_(s, ve, vp, vb)),
    ...
    result.emplace_back(variable_list({vb, vc, vd, vp}),
        difference(s, cons_(s, vd, vp, vb), cons_(s, vd, vp, vc)),
        difference(s, vb, vc));
    result.emplace_back(variable_list({vb, vc, vd, vp, vq}),
        less(vp, vq),
        difference(s, cons_(s, vd, vp, vb), cons_(s, vd, vq, vc)),
        difference(s, vb, vc));
    result.emplace_back(variable_list({vb, vc, vd, vp, vq}),
        less(vq, vp),
        difference(s, cons_(s, vd, vp, vb), cons_(s, vd, vq, vc)),
        cons_(s,
            vd,
            sort_nat::nat2pos(sort_nat::monus(sort_nat::pos2nat(vp), sort_nat::pos2nat(vq))),
            difference(s, vb, vc)));
    result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}),
        less(vd, ve),
        difference(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)),
        cons_(s, vd, vp, difference(s, vb, cons_(s, ve, vq, vc))));
    result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}),
        less(ve, vd),
        difference(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)),
        difference(s, cons_(s, vd, vp, vb), vc));
    result.emplace_back(variable_list({vb}), union_(s, vb, empty(s)), vb);
    result.emplace_back(variable_list({vc}), union_(s, empty(s), vc), vc);
    result.emplace_back(variable_list({vb, vc, vd, vp, vq}),
        union_(s, cons_(s, vd, vp, vb), cons_(s, vd, vq, vc)),
        cons_(s, vd, sort_pos::auxiliary_plus_pos(vp, vq), union_(s, vb, vc)));
    result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}),
        less(vd, ve),
        union_(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)),
        cons_(s, vd, vp, union_(s, vb, cons_(s, ve, vq, vc))));
    result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}),
        less(ve, vd),
        union_(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)),
        cons_(s, ve, vq, union_(s, cons_(s, vd, vp, vb), vc)));
    ...
    result.emplace_back(variable_list({vb, vc, vd, vp, vq}),
        intersection(s, cons_(s, vd, vp, vb), cons_(s, vd, vq, vc)),
        cons_(s, vd, sort_nat::minimum(vp, vq), intersection(s, vb, vc)));
    result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}),
        less(vd, ve),
        intersection(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)),
        intersection(s, vb, cons_(s, ve, vq, vc)));
    result.emplace_back(variable_list({vb, vc, vd, ve, vp, vq}),
        less(ve, vd),
        intersection(s, cons_(s, vd, vp, vb), cons_(s, ve, vq, vc)),
        intersection(s, cons_(s, vd, vp, vb), vc));
    ...
    result.emplace_back(variable_list({vb, vd, ve, vp, vq}),
        count_all(s, cons_(s, vd, vp, cons_(s, ve, vq, vb))),
        sort_nat::pos2nat(sort_pos::auxiliary_plus_pos(vp, sort_nat::nat2pos(count_all(s, cons_(s, ve, vq, vb))))));
