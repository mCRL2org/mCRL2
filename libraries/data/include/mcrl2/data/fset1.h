...
#ifndef MCRL2_DATA_FSET1_H
#define MCRL2_DATA_FSET1_H
...
namespace mcrl2::data::sort_fset
{
      ...
      /// \param[out] result The data expression where the \@fset_insert expression is put.
      /// \param[in] s A sort expression.
      /// \param[in] arg0 A data expression.
      /// \param[in] arg1 A data expression.
      inline
      ...
      /// \param[out] result The data expression where the \@fset_cons expression is put.
      /// \param[in] s A sort expression.
      /// \param[in] arg0 A data expression.
      /// \param[in] arg1 A data expression.
      inline
      ...
      /// \param[out] result The data expression where the \@fset_cinsert expression is put.
      /// \param[in] s A sort expression.
      /// \param[in] arg0 A data expression.
      /// \param[in] arg1 A data expression.
      /// \param[in] arg2 A data expression.
      ...
      data_equation_vector fset_generate_equations_code(const sort_expression& s)
      {
        ...
        result.emplace_back(variable_list({vd, vs}), equal_to(empty(s), cons_(s, vd, vs)), sort_bool::false_());
        result.emplace_back(variable_list({vd, vs}), equal_to(cons_(s, vd, vs), empty(s)), sort_bool::false_());
        result.emplace_back(variable_list({vd, ve, vs, vt}), equal_to(cons_(s, vd, vs), cons_(s, ve, vt)), sort_bool::and_(equal_to(vd, ve), equal_to(vs, vt)));
        ...
        result.emplace_back(variable_list({vd, ve, vs, vt}), less_equal(cons_(s, vd, vs), cons_(s, ve, vt)), if_(less(vd, ve), sort_bool::false_(), if_(equal_to(vd, ve), less_equal(vs, vt), less_equal(cons_(s, vd, vs), vt))));
        ...
        result.emplace_back(variable_list({vd, ve, vs, vt}), less(cons_(s, vd, vs), cons_(s, ve, vt)), if_(less(vd, ve), sort_bool::false_(), if_(equal_to(vd, ve), less(vs, vt), less_equal(cons_(s, vd, vs), vt))));
        ...
        result.emplace_back(variable_list({vd, ve, vs, vt}), less_total(cons_(s, vd, vs), cons_(s, ve, vt)), sort_bool::or_(less_total(vd, ve), sort_bool::and_(equal_to(vd, ve), less_total(vs, vt))));
        result.emplace_back(variable_list({vd}), insert(s, vd, empty(s)), cons_(s, vd, empty(s)));
        result.emplace_back(variable_list({vd, vs}), insert(s, vd, cons_(s, vd, vs)), cons_(s, vd, vs));
        result.emplace_back(variable_list({vd, ve, vs}), less_total(vd, ve), insert(s, vd, cons_(s, ve, vs)), cons_(s, vd, cons_(s, ve, vs)));
        result.emplace_back(variable_list({vd, ve, vs}), less_total(ve, vd), insert(s, vd, cons_(s, ve, vs)), cons_(s, ve, insert(s, vd, vs)));
        result.emplace_back(variable_list({vd, vs}), cinsert(s, vd, sort_bool::false_(), vs), vs);
        result.emplace_back(variable_list({vd, vs}), cinsert(s, vd, sort_bool::true_(), vs), insert(s, vd, vs));
        result.emplace_back(variable_list({vd}), in(s, vd, empty(s)), sort_bool::false_());
        result.emplace_back(variable_list({vd, ve, vs}), in(s, vd, cons_(s, ve, vs)), sort_bool::or_(equal_to(vd, ve), in(s, vd, vs)));
        result.emplace_back(variable_list({vd, ve, vs}), in(s, vd, insert(s, ve, vs)), sort_bool::or_(equal_to(vd, ve), in(s, vd, vs)));
        result.emplace_back(variable_list({vs}), difference(s, vs, empty(s)), vs);
        result.emplace_back(variable_list({vt}), difference(s, empty(s), vt), empty(s));
        result.emplace_back(variable_list({vd, vs, vt}), difference(s, cons_(s, vd, vs), cons_(s, vd, vt)), difference(s, vs, vt));
        result.emplace_back(variable_list({vd, ve, vs, vt}), less_total(vd, ve), difference(s, cons_(s, vd, vs), cons_(s, ve, vt)), cons_(s, vd, difference(s, vs, cons_(s, ve, vt))));
        result.emplace_back(variable_list({vd, ve, vs, vt}), less_total(ve, vd), difference(s, cons_(s, vd, vs), cons_(s, ve, vt)), difference(s, cons_(s, vd, vs), vt));
        result.emplace_back(variable_list({vs}), union_(s, vs, empty(s)), vs);
        result.emplace_back(variable_list({vt}), union_(s, empty(s), vt), vt);
        result.emplace_back(variable_list({vd, vs, vt}), union_(s, cons_(s, vd, vs), cons_(s, vd, vt)), cons_(s, vd, union_(s, vs, vt)));
        result.emplace_back(variable_list({vd, ve, vs, vt}), less_total(vd, ve), union_(s, cons_(s, vd, vs), cons_(s, ve, vt)), cons_(s, vd, union_(s, vs, cons_(s, ve, vt))));
        result.emplace_back(variable_list({vd, ve, vs, vt}), less_total(ve, vd), union_(s, cons_(s, vd, vs), cons_(s, ve, vt)), cons_(s, ve, union_(s, cons_(s, vd, vs), vt)));
        result.emplace_back(variable_list({vs}), intersection(s, vs, empty(s)), empty(s));
        result.emplace_back(variable_list({vt}), intersection(s, empty(s), vt), empty(s));
        result.emplace_back(variable_list({vd, vs, vt}), intersection(s, cons_(s, vd, vs), cons_(s, vd, vt)), cons_(s, vd, intersection(s, vs, vt)));
        result.emplace_back(variable_list({vd, ve, vs, vt}), less_total(vd, ve), intersection(s, cons_(s, vd, vs), cons_(s, ve, vt)), intersection(s, vs, cons_(s, ve, vt)));
        result.emplace_back(variable_list({vd, ve, vs, vt}), less_total(ve, vd), intersection(s, cons_(s, vd, vs), cons_(s, ve, vt)), intersection(s, cons_(s, vd, vs), vt));
        result.emplace_back(variable_list(), count(s, empty(s)), sort_nat::c0());
        result.emplace_back(variable_list({vd, vs}), count(s, cons_(s, vd, vs)), sort_nat::cnat(sort_nat::succ(count(s, vs))));
        result.emplace_back(variable_list({vs, vt}), not_equal_to(vs, vt), sort_bool::not_(equal_to(vs, vt)));
        result.emplace_back(variable_list({vd, vs}), pick(s, cons_(s, vd, vs)), vd);
        return result;
      }

} // namespace mcrl2::data::sort_fset

#endif // MCRL2_DATA_FSET1_H
