...
#ifndef MCRL2_DATA_REAL64_H
#define MCRL2_DATA_REAL64_H
...
namespace mcrl2::data::sort_real
{
      ...
      /// \param[out] result The data expression where the \@cReal expression is put.
      ...
      /// \param[out] result The data expression where the Pos2Real expression is put.
      ...
      /// \param[out] result The data expression where the Nat2Real expression is put.
      ...
      /// \param[out] result The data expression where the Int2Real expression is put.
      ...
      /// \param[out] result The data expression where the Real2Pos expression is put.
      ...
      /// \param[out] result The data expression where the Real2Nat expression is put.
      ...
      /// \param[out] result The data expression where the Real2Int expression is put.
      ...
      /// \param[out] result The data expression where the abs expression is put.
      ...
      /// \param[out] result The data expression where the floor expression is put.
      ...
      /// \param[out] result The data expression where the ceil expression is put.
      ...
      /// \param[out] result The data expression where the round expression is put.
      ...
      /// \param[out] result The data expression where the \@redfrac expression is put.
      ...
      {
        static function_symbol reduce_fraction_where(reduce_fraction_where_name(), make_function_sort_(sort_nat::nat(), sort_int::int_(), sort_nat::nat(), real_()));
      ...
      /// \param[out] result The data expression where the \@redfracwhr expression is put.
      ...
      /// \param[out] result The data expression where the \@redfrachlp expression is put.
      ...
      data_equation_vector real_generate_equations_code()
      {
        ...
        result.emplace_back(variable_list({vp, vq, vx, vy}), equal_to(creal(vx, vp), creal(vy, vq)), equal_to(times(vx, sort_int::cint(sort_nat::pos2nat(vq))), times(vy, sort_int::cint(sort_nat::pos2nat(vp)))));
        result.emplace_back(variable_list({vp, vq, vx, vy}), less(creal(vx, vp), creal(vy, vq)), less(times(vx, sort_int::cint(sort_nat::pos2nat(vq))), times(vy, sort_int::cint(sort_nat::pos2nat(vp)))));
        result.emplace_back(variable_list({vp, vq, vx, vy}), less_equal(creal(vx, vp), creal(vy, vq)), less_equal(times(vx, sort_int::cint(sort_nat::pos2nat(vq))), times(vy, sort_int::cint(sort_nat::pos2nat(vp)))));
        ...
        result.emplace_back(variable_list({vp}), pos2real(vp), creal(sort_int::cint(sort_nat::pos2nat(vp)), sort_pos::c1()));
        result.emplace_back(variable_list({vp, vx}), equal_to(vp, sort_pos::c1()), real2int(creal(vx, vp)), vx);
        result.emplace_back(variable_list({vp, vx}), equal_to(vp, sort_pos::c1()), real2nat(creal(vx, vp)), sort_int::int2nat(vx));
        result.emplace_back(variable_list({vp, vx}), equal_to(vp, sort_pos::c1()), real2pos(creal(vx, vp)), sort_int::int2pos(vx));
        ...
        result.emplace_back(variable_list({vr}), abs(vr), if_(less(vr, creal(sort_int::cint(sort_nat::c0()), sort_pos::c1())), negate(vr), vr));
        result.emplace_back(variable_list({vp, vx}), negate(creal(vx, vp)), creal(negate(vx), vp));
        result.emplace_back(variable_list({vp, vx}), succ(creal(vx, vp)), creal(plus(vx, sort_int::cint(sort_nat::pos2nat(vp))), vp));
        result.emplace_back(variable_list({vp, vx}), pred(creal(vx, vp)), creal(minus(vx, sort_int::cint(sort_nat::pos2nat(vp))), vp));
        result.emplace_back(variable_list({vp, vq, vx, vy}), plus(creal(vx, vp), creal(vy, vq)), reduce_fraction(plus(times(vx, sort_int::cint(sort_nat::pos2nat(vq))), times(vy, sort_int::cint(sort_nat::pos2nat(vp)))), sort_int::cint(sort_nat::pos2nat(times(vp, vq)))));
        result.emplace_back(variable_list({vp, vq, vx, vy}), minus(creal(vx, vp), creal(vy, vq)), reduce_fraction(minus(times(vx, sort_int::cint(sort_nat::pos2nat(vq))), times(vy, sort_int::cint(sort_nat::pos2nat(vp)))), sort_int::cint(sort_nat::pos2nat(times(vp, vq)))));
        result.emplace_back(variable_list({vp, vq, vx, vy}), times(creal(vx, vp), creal(vy, vq)), reduce_fraction(times(vx, vy), sort_int::cint(sort_nat::pos2nat(times(vp, vq)))));
        result.emplace_back(variable_list({vm, vp, vr}), sort_nat::equals_zero(vm), times(vr, creal(sort_int::cint(vm), vp)), creal(sort_int::cint(sort_nat::c0()), sort_pos::c1()));
        result.emplace_back(variable_list({vm, vp, vr}), sort_nat::equals_zero(vm), times(creal(sort_int::cint(vm), vp), vr), creal(sort_int::cint(sort_nat::c0()), sort_pos::c1()));
        result.emplace_back(variable_list({vp, vq, vx, vy}), not_equal_to(vy, sort_int::cint(sort_nat::c0())), divides(creal(vx, vp), creal(vy, vq)), reduce_fraction(times(vx, sort_int::cint(sort_nat::pos2nat(vq))), times(vy, sort_int::cint(sort_nat::pos2nat(vp)))));
        result.emplace_back(variable_list({vp, vq}), divides(vp, vq), reduce_fraction(sort_int::cint(sort_nat::pos2nat(vp)), sort_int::cint(sort_nat::pos2nat(vq))));
        result.emplace_back(variable_list({vm, vn}), not_equal_to(vn, sort_nat::c0()), divides(vm, vn), reduce_fraction(sort_int::cint(vm), sort_int::cint(vn)));
        result.emplace_back(variable_list({vx, vy}), not_equal_to(vy, sort_int::cint(sort_nat::c0())), divides(vx, vy), reduce_fraction(vx, vy));
        result.emplace_back(variable_list({vn, vp, vx}), exp(creal(vx, vp), sort_int::cint(vn)), reduce_fraction(exp(vx, vn), sort_int::cint(sort_nat::pos2nat(exp(vp, vn)))));
        result.emplace_back(variable_list({vp, vq, vx}), not_equal_to(vx, sort_int::cint(sort_nat::c0())), exp(creal(vx, vp), sort_int::cneg(vq)), reduce_fraction(sort_int::cint(sort_nat::pos2nat(exp(vp, sort_nat::pos2nat(vq)))), exp(vx, sort_nat::pos2nat(vq))));
        ...
        result.emplace_back(variable_list({vr}), round(vr), floor(plus(vr, creal(sort_int::cint(sort_nat::pos2nat(sort_pos::c1())), plus(sort_pos::c1(), sort_pos::c1())))));
        result.emplace_back(variable_list({vp, vx}), reduce_fraction(vx, sort_int::cneg(vp)), reduce_fraction(negate(vx), sort_int::cint(sort_nat::pos2nat(vp))));
        result.emplace_back(variable_list({vn, vx}), reduce_fraction(vx, sort_int::cint(vn)), reduce_fraction_where(vn, sort_int::div(vx, sort_nat::nat2pos(vn)), sort_int::mod(vx, sort_nat::nat2pos(vn))));
        result.emplace_back(variable_list({vm, vn, vx}), sort_nat::equals_zero(vm), reduce_fraction_where(vn, vx, vm), creal(vx, sort_pos::c1()));
        result.emplace_back(variable_list({vm, vn, vx}), sort_nat::not_equals_zero(vm), reduce_fraction_where(vn, vx, vm), reduce_fraction_helper(reduce_fraction(sort_int::cint(vn), sort_int::cint(vm)), vx));
        result.emplace_back(variable_list({vp, vx, vy}), reduce_fraction_helper(creal(vx, vp), vy), creal(plus(sort_int::cint(sort_nat::pos2nat(vp)), times(vy, vx)), sort_int::int2pos(vx)));
        return result;
      }
