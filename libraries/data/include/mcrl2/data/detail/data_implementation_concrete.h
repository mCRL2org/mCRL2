...
ATermAppl impl_exprs_appl(ATermAppl part, ATermList *p_substs,
  core::detail::t_data_decls *p_data_decls, ATermList* data_equations);
...
void impl_sort_struct(ATermAppl sort_struct, ATermAppl sort_id,
  ATermList *p_substs, core::detail::t_data_decls *p_data_decls, bool recursive = true, ATermList* data_equations = 0);
...
void impl_sort_list(ATermAppl sort_expression_list, ATermAppl sort_id,
  ATermList *p_substs, core::detail::t_data_decls *p_data_decls, ATermList* data_equations);
...
void impl_sort_pos(core::detail::t_data_decls *p_data_decls, ATermList* data_equations);
...
void impl_sort_nat(core::detail::t_data_decls *p_data_decls, bool recursive = true, ATermList* data_equations = 0);

/// \pre p_data_decls represents a pointer to new data declarations
/// \post an implementation of sort Int is added to *p_data_decls
///       if recursive, then the sorts it depends on are also implemented
void impl_sort_int(core::detail::t_data_decls *p_data_decls, bool recursive = true, ATermList* data_equations = 0);

/// \pre p_data_decls represents a pointer to new data declarations
/// \post an implementation of sort Real is added to *p_data_decls
///       if recursive, then the sorts it depends on are also implemented
void impl_sort_real(core::detail::t_data_decls *p_data_decls, bool recursive = true, ATermList* data_equations = 0);
