...
namespace mcrl2 {
  ...
  namespace data {
    ...
    namespace detail {
      ...
      ///                 data implementation.
      /// \return A list of sort expressions in the new data format, containing
      ...
      ///                 data implementation.
      /// \return A list of function declaration in the new data format, containing
      ...
      ///                 data implementation.
      /// \return A list of data equations in the new data format, containing
