  ...
  namespace data {
    ...
    namespace sort_bag {
      ...
      data_equation_list bag_generate_equations_code(const sort_expression& s)
      {
        ...
        result.push_back(data_equation(make_vector(variable("d", s), variable("s", sort_bag::bag(s))), sort_bag::bagin(s, variable("d", s), variable("s", sort_bag::bag(s))), sort_pos::greater(sort_bag::count(s, variable("d", s), variable("s", sort_bag::bag(s))), sort_nat::c0())));
        ...
        result.push_back(data_equation(make_vector(variable("u", sort_set::set(s))), sort_bag::set2bag(s, variable("u", sort_set::set(s))), sort_bag::bag_comprehension(s, lambda(make_vector(variable("x", s)),if_(sort_bag::bagin(s, variable("x", s), variable("u", sort_set::set(s))), sort_nat::cnat(sort_pos::c1()), sort_nat::c0())))));
