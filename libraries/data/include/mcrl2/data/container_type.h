...
class list_container: public container_type
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit list_container(const atermpp::aterm_core& term)
      : container_type(term)
    {
...
class set_container: public container_type
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit set_container(const atermpp::aterm_core& term)
      : container_type(term)
    {
...
class bag_container: public container_type
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit bag_container(const atermpp::aterm_core& term)
      : container_type(term)
    {
...
class fset_container: public container_type
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit fset_container(const atermpp::aterm_core& term)
      : container_type(term)
    {
...
class fbag_container: public container_type
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit fbag_container(const atermpp::aterm_core& term)
      : container_type(term)
    {
