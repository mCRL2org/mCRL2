...
struct add_traverser_sort_expressions: public Traverser<Derived>
{
  ...
  void operator()(const data::data_expression& x)
  {
    ...
    {
      static_cast<Derived&>(*this)(data::abstraction(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_identifier(x))
    {
      static_cast<Derived&>(*this)(data::identifier(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_variable(x))
    {
      static_cast<Derived&>(*this)(data::variable(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_function_symbol(x))
    {
      static_cast<Derived&>(*this)(data::function_symbol(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_application(x))
    {
      static_cast<Derived&>(*this)(data::application(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_where_clause(x))
    {
      static_cast<Derived&>(*this)(data::where_clause(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
  }
  ...
  void operator()(const data::assignment_expression& x)
  {
    ...
    {
      static_cast<Derived&>(*this)(data::assignment(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_identifier_assignment(x))
    {
      static_cast<Derived&>(*this)(data::identifier_assignment(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
  }
  ...
  void operator()(const data::sort_expression& x)
  {
    ...
    {
      static_cast<Derived&>(*this)(data::basic_sort(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_container_sort(x))
    {
      static_cast<Derived&>(*this)(data::container_sort(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_structured_sort(x))
    {
      static_cast<Derived&>(*this)(data::structured_sort(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_function_sort(x))
    {
      static_cast<Derived&>(*this)(data::function_sort(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_unknown_sort(x))
    {
      static_cast<Derived&>(*this)(data::unknown_sort(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_multiple_possible_sorts(x))
    {
      static_cast<Derived&>(*this)(data::multiple_possible_sorts(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
  }
  ...
  void operator()(const data::abstraction& x)
  {
    ...
    if (data::is_forall(x))
    {
      static_cast<Derived&>(*this)(data::forall(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_exists(x))
    {
      static_cast<Derived&>(*this)(data::exists(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (data::is_lambda(x))
    {
      static_cast<Derived&>(*this)(data::lambda(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
  }
