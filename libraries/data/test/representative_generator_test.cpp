...
void test_representative_generator()
{
  ...
  BOOST_CHECK(default_expression_generator(basic_sort("E")) ==
      application(boost::next(constructors.begin(), 1)->constructor_function(specification.normalise(basic_sort("E"))), default_expression_generator(sort_nat::nat())));
  ...
  BOOST_CHECK(default_expression_generator(basic_sort("D")) ==
       application(boost::next(constructors.begin(), 0)->constructor_function(specification.normalise(basic_sort("D"))), default_expression_generator(basic_sort("E"))));
}
