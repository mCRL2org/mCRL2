...
void representation_check(Rewriter& R, const data_expression& input, const data_expression& expected, const data_specification& spec)
{
...
void number_test()
{
  ...
  representation_check(R, number(sort_pos::pos(), "1"), R(sort_pos::c1()),specification);
