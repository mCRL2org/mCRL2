...
BOOST_AUTO_TEST_CASE(structured_sort_test)
{
  ...
  structured_sort_constructor_argument_vector nv {structured_sort_constructor_argument(static_cast<sort_expression const&>(sort_nat::nat()))};
  structured_sort_constructor_argument_vector bv {structured_sort_constructor_argument(static_cast<sort_expression const&>(sort_bool::bool_()))};
  structured_sort_constructor b("B", nv);
  structured_sort_constructor c("C", bv);
  structured_sort bc(structured_sort_constructor_list({b,c}));
