...
void test_expressions(Rewriter R, const std::string& expr1, const std::string& expr2, const std::string& declarations, const data_specification& data_spec, const std::string& substitution_text)
{
  data::rewriter::substitution_type sigma;
