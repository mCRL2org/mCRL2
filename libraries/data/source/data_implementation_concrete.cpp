...
static ATermAppl impl_sort_struct(ATermAppl sort_struct, ATermList *p_substs,
  t_data_decls *p_data_decls, bool recursive = true);
...
{
  data_equation_list equations = sort_set::set_generate_equations_code(sort_expression(sort_elt));
  return atermpp::term_list<data_equation>(equations.begin(), equations.end());
}
  ...
  t_data_decls *p_data_decls)
{
  ...
  *p_substs = gsAddSubstToSubsts(subst, *p_substs);
  ...
  // set has no constructors
  //function_symbol_list constructors = sort_set::set_generate_constructors_code(element_sort);
  function_symbol_list functions = sort_set::set_generate_functions_code(element_sort);
  data_equation_list equations = sort_set::set_generate_equations_code(element_sort);
...
{
  data_equation_list equations = sort_bag::bag_generate_equations_code(sort_expression(sort_elt));
  return atermpp::term_list<data_equation>(equations.begin(), equations.end());
}
  ...
  t_data_decls *p_data_decls)
{
  ...
  //also needs corresponding set sort
  ...
  *p_substs = gsAddSubstToSubsts(subst, *p_substs);
  ...
  // bag has no constructors
  //function_symbol_list constructors = sort_bag::bag_generate_constructors_code(element_sort);
  function_symbol_list functions = sort_bag::bag_generate_functions_code(element_sort);
  data_equation_list equations = sort_bag::bag_generate_equations_code(element_sort);
