...
bool mcrl2::data::data_type_checker::MatchIf(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(sort_bool::bool_(),Res,Res),Res);
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchEqNeqComparison(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(Arg,Arg),sort_bool::bool_());
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchListOpCons(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(Res,static_cast<sort_expression>(sort_list::list(sort_expression(Res)))),sort_list::list(sort_expression(Res)));
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchListOpSnoc(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(static_cast<sort_expression>(sort_list::list(sort_expression(Res))),Res),sort_list::list(sort_expression(Res)));
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchListOpConcat(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(static_cast<sort_expression>(sort_list::list(sort_expression(Res))),
...
bool mcrl2::data::data_type_checker::MatchListOpHead(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(static_cast<sort_expression>(sort_list::list(sort_expression(Res)))),Res);
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchSetOpSet2Bag(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(static_cast<sort_expression>(sort_set::set_(sort_expression(Arg)))),
...
bool mcrl2::data::data_type_checker::MatchListSetBagOpIn(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(Arg,Arg2.set_argument(Arg,1)),sort_bool::bool_());
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchSetBagOpUnionDiffIntersect(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(Res,Res),Res);
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchSetOpSetCompl(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(static_cast<sort_expression>(sort_set::set_(sort_expression(Res)))),sort_set::set_(sort_expression(Res)));
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchBagOpBag2Set(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(static_cast<sort_expression>(sort_bag::bag(sort_expression(Arg)))),sort_set::set_(sort_expression(Arg)));
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchBagOpBagCount(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(Arg,static_cast<sort_expression>(sort_bag::bag(sort_expression(Arg)))),sort_nat::nat());
  return true;
}
...
bool mcrl2::data::data_type_checker::MatchFuncUpdate(const sort_expression &type, sort_expression &result)
{
  ...
  result=function_sort(make_list<aterm>(Arg1,A,B),Arg1);
  return true;
}
...
void mcrl2::data::data_type_checker::ReadInSortStruct(const sort_expression &SortExpr)
{
  ...
  if (is_structured_sort(SortExpr))
  {
               ...
               i!=struct_sort.struct_constructors().end(); ++i)
    {
      ...
      {
        AddFunction(data::function_symbol(Name,function_sort(make_list<aterm>(SortExpr),sort_bool::bool_())),"recognizer");
      }
                      ...
                      variable_list VarDecls)
{
  ...
  {
    aterm_appl VarDecl=VarDecls.front();
...
static bool HasUnknown(const sort_expression &Type)
{
  ...
  if (is_container_sort(Type))
  {
    return HasUnknown(aterm_cast<aterm_appl>(Type[1]));
  }
  if (is_structured_sort(Type))
  {
    return false;
