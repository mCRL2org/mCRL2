...
push_allow_node push_allow(const process_expression& x, const multi_action_name_set& A, bool A_includes_subsets, const std::vector<process_equation>& equations);
...
#include "mcrl2/core/detail/traverser_msvc.inc.h"
  ...
  push_allow_traverser(const std::vector<process_equation>& equations, std::set<process_identifier>& W, const multi_action_name_set& A_, bool A_includes_subsets_)
  ...
  void log_push_result(const process_expression& x, const multi_action_name_set& A, bool A_includes_subsets, const push_allow_node& result, const std::string& msg = "")
  {
    ...
    result1.finish(A, A_includes_subsets);
...
struct apply_push_allow_traverser: public Traverser<apply_push_allow_traverser<Traverser, Node>, Node>
{
  ...
  apply_push_allow_traverser(const std::vector<process_equation>& equations, std::set<process_identifier>& W, const multi_action_name_set& A, bool A_includes_subsets)
