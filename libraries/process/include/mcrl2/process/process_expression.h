...
class action: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit action(const atermpp::aterm_core& term)
...
class process_instance: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit process_instance(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class process_instance_assignment: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit process_instance_assignment(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class delta: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit delta(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class tau: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit tau(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class block: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit block(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class hide: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit hide(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class rename: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit rename(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class comm: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit comm(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class allow: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit allow(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class sync: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit sync(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class if_then: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit if_then(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class if_then_else: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit if_then_else(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class bounded_init: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit bounded_init(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class merge: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit merge(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class left_merge: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit left_merge(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class choice: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit choice(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class stochastic_operator: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit stochastic_operator(const atermpp::aterm_core& term)
      : process_expression(term)
    {
...
class untyped_process_assignment: public process_expression
{
  public:
    ...
    /// \\brief Constructor.
    /// \\param term A term
    explicit untyped_process_assignment(const atermpp::aterm_core& term)
      : process_expression(term)
    {
