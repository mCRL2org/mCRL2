...
{
  return data::detail::make_rewrite_data_expressions_builder<process::data_expression_builder>(R).apply(x);
}
...
{
  return data::detail::make_rewrite_data_expressions_with_substitution_builder<process::data_expression_builder>(R, sigma).apply(x);
}
