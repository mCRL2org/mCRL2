...
//--- start generated process substitute code ---//
...
{
  data::detail::make_substitute_sort_expressions_builder<process::sort_expression_builder>(sigma, innermost)(x);
}
...
{
  return data::detail::make_substitute_sort_expressions_builder<process::sort_expression_builder>(sigma, innermost)(x);
}
...
{
  data::detail::make_substitute_data_expressions_builder<process::data_expression_builder>(sigma, innermost)(x);
}
...
{
  return data::detail::make_substitute_data_expressions_builder<process::data_expression_builder>(sigma, innermost)(x);
}
...
//--- end generated process substitute code ---//
