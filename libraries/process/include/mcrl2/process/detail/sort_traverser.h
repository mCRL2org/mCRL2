...
//
/// \file mcrl2/process/detail/sort_traverser.h
/// \brief add your file description here.

#ifndef MCRL2_PROCESS_DETAIL_SORT_TRAVERSER_H
#define MCRL2_PROCESS_DETAIL_SORT_TRAVERSER_H
...
namespace detail {
  ...
  /// \brief Adds process traversal functions to the data sort traverser.
...
#include "mcrl2/process/detail/traverser.inc"
  ...
  /// \brief Adds process traversal functions to the data selective sort traverser.
...
#endif // MCRL2_PROCESS_DETAIL_SORT_TRAVERSER_H
