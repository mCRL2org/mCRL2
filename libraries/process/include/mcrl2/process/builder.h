...
struct add_sort_expressions: public Builder<Derived>
{
  ...
  process::process_expression operator()(const process::untyped_process_assignment& x)
  {
    static_cast<Derived&>(*this).enter(x);
    process::process_expression result = process::untyped_process_assignment(x.name(), static_cast<Derived&>(*this)(x.assignments()));
    static_cast<Derived&>(*this).leave(x);
    return result;
  }
...
struct add_process_identifiers: public Builder<Derived>
{
  ...
  {
    static_cast<Derived&>(*this).enter(x);
    process::process_expression result = process::process_instance(static_cast<Derived&>(*this)(x.identifier()), x.actual_parameters());
    static_cast<Derived&>(*this).leave(x);
    return result;
  }
  ...
  {
    static_cast<Derived&>(*this).enter(x);
    process::process_expression result = process::process_instance_assignment(static_cast<Derived&>(*this)(x.identifier()), x.assignments());
    static_cast<Derived&>(*this).leave(x);
    return result;
  }
