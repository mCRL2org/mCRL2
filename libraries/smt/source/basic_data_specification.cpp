  ...
  const std::shared_ptr<function_definition>& abs)
{
  ...
  add_function_definition(data::sort_pos::succ(), data::variable_vector({p1}), data::sort_pos::plus(p1, pos_one));
  ...
  add_function_definition(data::sort_nat::maximum(pos, nat), maximum, data::variable_vector({p1, n1}), data::sort_nat::nat2pos(data::if_(data::greater(data::sort_nat::pos2nat(p1), n1), data::sort_nat::pos2nat(p1), n1)));
  add_function_definition(data::sort_nat::maximum(nat, pos), maximum, data::variable_vector({n1, p1}), data::sort_nat::nat2pos(data::if_(data::greater(data::sort_nat::pos2nat(p1), n1), data::sort_nat::pos2nat(p1), n1)));
  add_function_definition(data::sort_nat::maximum(nat, nat), maximum, data::variable_vector({n1, n2}), data::if_(data::greater(n1, n2), n1, n2));
  ...
  add_function_definition(data::sort_int::negate(pos), unary_minus, data::variable_vector({p1}), data::sort_int::minus(int_zero, data::sort_int::pos2int(p1)));
  add_function_definition(data::sort_int::negate(nat), unary_minus, data::variable_vector({n1}), data::sort_int::minus(int_zero, data::sort_int::nat2int(n1)));
  add_function_definition(data::sort_int::negate(int_), unary_minus, data::variable_vector({i1}), data::sort_int::minus(int_zero, i1));
  add_function_definition(data::sort_int::maximum(pos, int_), maximum, data::variable_vector({p1, i1}), data::sort_int::int2pos(data::if_(data::greater(data::sort_int::pos2int(p1), i1), data::sort_int::pos2int(p1), i1)));
  add_function_definition(data::sort_int::maximum(int_, pos), maximum, data::variable_vector({i1, p1}), data::sort_int::int2pos(data::if_(data::greater(data::sort_int::pos2int(p1), i1), data::sort_int::pos2int(p1), i1)));
  add_function_definition(data::sort_int::maximum(nat, int_), maximum, data::variable_vector({n1, i1}), data::sort_int::int2nat(data::if_(data::greater(data::sort_int::nat2int(n1), i1), data::sort_int::nat2int(n1), i1)));
  add_function_definition(data::sort_int::maximum(int_, nat), maximum, data::variable_vector({i1, n1}), data::sort_int::int2nat(data::if_(data::greater(data::sort_int::nat2int(n1), i1), data::sort_int::nat2int(n1), i1)));
  add_function_definition(data::sort_int::maximum(int_, int_), maximum, data::variable_vector({i1, i2}), data::if_(data::greater(i1, i2), i1, i2));
  add_function_definition(data::sort_int::minimum(int_, int_), minimum, data::variable_vector({i1, i2}), data::if_(data::less(i1, i2), i1, i2));
  add_function_definition(data::sort_int::abs(), abs, data::variable_vector({i1}), data::if_(data::less(i1, int_zero), data::sort_int::negate(i1), i1));
  ...
  add_function_definition(data::sort_real::ceil(), ceil, data::variable_vector({r1}), data::sort_real::negate(data::sort_real::floor(data::sort_real::negate(r1))));
  add_function_definition(data::sort_real::round(), round, data::variable_vector({r1}), data::sort_real::floor(data::sort_real::plus(r1, real_half)));
  add_function_definition(data::sort_real::negate(real), unary_minus, data::variable_vector({r1}), data::sort_real::minus(real_zero, r1));
  add_function_definition(data::sort_real::maximum(real, real), maximum, data::variable_vector({r1, r2}), data::if_(data::greater(r1, r2), r1, r2));
  add_function_definition(data::sort_real::minimum(real, real), minimum, data::variable_vector({r1, r2}), data::if_(data::less(r1, r2), r1, r2));
  add_function_definition(data::sort_real::abs(real), abs, data::variable_vector({r1}), data::if_(data::less(r1, real_zero), data::sort_real::negate(r1), r1));
  ...
  add_function_definition(data::sort_real::succ(real), data::variable_vector({r1}), data::sort_real::plus(r1, real_one));
  add_function_definition(data::sort_real::pred(real), data::variable_vector({r1}), data::sort_real::minus(r1, real_one));
}
