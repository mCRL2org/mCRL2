...
/// \param[out] t The reference into which the new alt is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new trans is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new trans_or_nil is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new untyped_regular_formula is constructed.
template <class... ARGUMENTS>
