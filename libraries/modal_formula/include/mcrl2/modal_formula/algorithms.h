...
state_formula parse_state_formula(std::istream& in, lps::specification& spec, const bool formula_is_quantitative);
...
/// \param formula_is_quantitative True if the formula is interpreted as a quantitative formula, instead of a classic boolean modal formula.
/// \return The converted modal formula
state_formula parse_state_formula(const std::string& formula_text, lps::specification& spec, const bool formula_is_quantitative);
