...
/// \param[out] t The reference into which the new minus is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new plus is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new const_multiply is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new const_multiply_alt is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new infimum is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new supremum is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new must is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new may is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new yaled_timed is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new delay_timed is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new nu is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new mu is constructed.
template <class... ARGUMENTS>
