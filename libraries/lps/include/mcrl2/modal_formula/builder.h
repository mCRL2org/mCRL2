...
struct add_sort_expressions: public Builder<Derived>
{
  ...
  action_formulas::action_formula operator()(const action_formulas::action_formula& x)
  {
    ...
    {
      result = static_cast<Derived&>(*this)(action_formulas::true_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (action_formulas::is_false(x))
    {
      result = static_cast<Derived&>(*this)(action_formulas::false_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (action_formulas::is_not(x))
    {
      result = static_cast<Derived&>(*this)(action_formulas::not_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (action_formulas::is_and(x))
    {
      result = static_cast<Derived&>(*this)(action_formulas::and_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (action_formulas::is_or(x))
    {
      result = static_cast<Derived&>(*this)(action_formulas::or_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (action_formulas::is_imp(x))
    {
      result = static_cast<Derived&>(*this)(action_formulas::imp(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (action_formulas::is_forall(x))
    {
      result = static_cast<Derived&>(*this)(action_formulas::forall(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (action_formulas::is_exists(x))
    {
      result = static_cast<Derived&>(*this)(action_formulas::exists(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (action_formulas::is_at(x))
    {
      result = static_cast<Derived&>(*this)(action_formulas::at(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
...
struct add_sort_expressions: public Builder<Derived>
{
  ...
  regular_formulas::regular_formula operator()(const regular_formulas::regular_formula& x)
  {
    ...
    {
      result = static_cast<Derived&>(*this)(action_formulas::action_formula(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (regular_formulas::is_nil(x))
    {
      result = static_cast<Derived&>(*this)(regular_formulas::nil(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (regular_formulas::is_seq(x))
    {
      result = static_cast<Derived&>(*this)(regular_formulas::seq(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (regular_formulas::is_alt(x))
    {
      result = static_cast<Derived&>(*this)(regular_formulas::alt(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (regular_formulas::is_trans(x))
    {
      result = static_cast<Derived&>(*this)(regular_formulas::trans(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (regular_formulas::is_trans_or_nil(x))
    {
      result = static_cast<Derived&>(*this)(regular_formulas::trans_or_nil(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
    return result;
  }
...
struct add_sort_expressions: public Builder<Derived>
{
  ...
  state_formulas::state_formula operator()(const state_formulas::state_formula& x)
  {
    ...
    {
      result = static_cast<Derived&>(*this)(state_formulas::true_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_false(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::false_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_not(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::not_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_and(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::and_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_or(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::or_(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_imp(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::imp(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_forall(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::forall(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_exists(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::exists(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_must(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::must(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_may(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::may(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_yaled(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::yaled(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_yaled_timed(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::yaled_timed(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_delay(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::delay(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_delay_timed(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::delay_timed(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_variable(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::variable(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_nu(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::nu(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    else if (state_formulas::is_mu(x))
    {
      result = static_cast<Derived&>(*this)(state_formulas::mu(atermpp::aterm_cast<const atermpp::aterm_appl>(x)));
    }
    static_cast<Derived&>(*this).leave(x);
    return result;
  }
