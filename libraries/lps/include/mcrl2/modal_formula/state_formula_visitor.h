...
struct state_formula_visitor
{
  ...
  /// \return The result of visiting the node
  virtual bool visit_forall(const state_formula& /* e */, const data::variable_list& /* variables */, const state_formula& /* expression */)
  {
    return true;
  }
  ...
  /// \return The result of visiting the node
  virtual bool visit_exists(const state_formula& /* e */, const data::variable_list& /* variables */, const state_formula& /* expression */)
  {
    return true;
  }
  ...
  /// \brief Visit mu node
  /// \return The result of visiting the node
  virtual bool visit_mu(const state_formula& /* e */, const core::identifier_string& /* n */, const data::assignment_list& /* a */, const state_formula& /* f */)
  {
    return true;
  }
  ...
  /// \brief Visit nu node
  /// \return The result of visiting the node
  virtual bool visit_nu(const state_formula& /* e */, const core::identifier_string& /* n */, const data::assignment_list& /* a */, const state_formula& /* f */)
  {
    return true;
  }
