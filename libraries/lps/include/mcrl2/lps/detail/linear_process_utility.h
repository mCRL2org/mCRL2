...
namespace detail {
  ...
  std::set<core::identifier_string> process_parameter_names(const linear_process& p)
  {
    ...
    new_data::variable_list parameters(p.process_parameters());
    result.insert(boost::make_transform_iterator(parameters.begin(), new_data::detail::variable_name()),
                  boost::make_transform_iterator(parameters.end()  , new_data::detail::variable_name()));
    return result;
  }
  ...
  std::set<core::identifier_string> free_variable_names(const linear_process& p)
  {
    ...
    result.insert(boost::make_transform_iterator(free_variables.begin(), new_data::detail::variable_name()),
  ...
  std::set<core::identifier_string> summand_variable_names(const linear_process& p)
  {
    ...
    for (summand_list::iterator i = p.summands().begin(); i != p.summands().end(); ++i)
    {
      ...
      result.insert(
        boost::make_transform_iterator(summation_variables.begin(), new_data::detail::variable_name()),
