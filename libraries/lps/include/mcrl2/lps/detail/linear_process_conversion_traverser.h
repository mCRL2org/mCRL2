...
// std::cout << "adding multi action\n" << m_multi_action.to_string() << std::endl;
  ...
  void operator()(const process::seq& x)
  {
    ...
    {
      const process_instance& p = core::down_cast<process_instance>(x.right());
    ...
    {
      const process_instance_assignment& p = core::down_cast<process_instance_assignment>(x.right());
...
// std::cout << "adding condition\n" << data::pp(m_condition) << std::endl;
  ...
  lps::specification convert(const process_specification& p)
  {
    ...
    {
      const process_instance& init = core::down_cast<process_instance>(p.init());
    ...
    {
      const process_instance_assignment& init = core::down_cast<process_instance_assignment>(p.init());
