...
void collect_free_variables(const summand& s, const std::set<data::variable>& bound_variables, OutputIterator dest)
{
  atermpp::for_each(s, mcrl2::data::detail::make_variable_collector(bound_variables.begin(),
                                                            bound_variables.end(),
