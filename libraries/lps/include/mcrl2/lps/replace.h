...
{
  lps::replace_variables_capture_avoiding(x, sigma, substitution_variables(sigma));
}
...
{
  return lps::replace_variables_capture_avoiding(x, sigma, substitution_variables(sigma));
}
