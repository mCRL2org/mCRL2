...
namespace lps {
  ...
  {
    data::detail::make_find_helper< data::sort_expression, lps::detail::sort_traverser >(dest)(o);
  }
  ...
  {
    data::detail::make_find_helper< data::variable, lps::detail::traverser >(dest)(o);
  }
