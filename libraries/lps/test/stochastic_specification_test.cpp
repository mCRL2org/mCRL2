...
std::string result2 =
    ...
    "     dc6,dc5,dc4,dc2,dc1,dc: Coin;\n"
    "\n"
    "proc P(c5: Coin, s1_X: Pos, c3_X,c4_X,c_X: Coin, head_seen_X: Bool) =\n"
    "       (s1_X == 2 && c_X == head_ && head_seen_X) ->\n"
    "         success .\n"
    "         P(s1_X = 3, c3_X = dc4, c4_X = dc5, c_X = dc6, head_seen_X = dc8)\n"
    "     + sum e_X: Enum3.\n"
    "         C3_2(e_X, s1_X == 2 && c_X == tail_, s1_X == 2 && c_X == head_ && !head_seen_X, s1_X == 1) ->\n"
    "         throw(C3_(e_X, c4_X, c3_X, c5)) .\n"
    "         dist c7_X,c6_X: Coin[1 / 4] .\n"
    "         P(s1_X = 2, c3_X = c7_X, c4_X = c6_X, c_X = C3_(e_X, c6_X, c7_X, c5), head_seen_X = C3_2(e_X, false, true, head_seen_X));\n"
    "\n"
    "init dist c5: Coin[1 / 2] . P(1, dc2, dc1, dc, false);\n"
    ;
