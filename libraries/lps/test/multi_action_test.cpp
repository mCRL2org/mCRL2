...
void test_equal_multi_actions()
{
  ...
  process::action_list a1  = { act("a", { d1 }) };
  process::action_list a2  = { act("a", { d2 }) };
  process::action_list b1  = { act("b", { d1 }) };
  process::action_list b2  = { act("b", { d2 }) };
  process::action_list a11 = { act("a", { d1 }), act("a", { d1 }) };
  process::action_list a12 = { act("a", { d1 }), act("a", { d2 }) };
  process::action_list a21 = { act("a", { d2 }), act("a", { d1 }) };
  process::action_list a22 = { act("a", { d2 }), act("a", { d2 }) };
  process::action_list a34 = { act("a", { d3 }), act("a", { d4 }) };
  process::action_list a12b1 = { act("a", { d1 }), act("a", { d2 }), act("b", { d1 }) };
  process::action_list a34b2 = { act("a", { d3 }), act("a", { d4 }), act("b", { d2 }) };
