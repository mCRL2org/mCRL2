...
#ifndef MCRL2_PG_LINEAR_LIFTING_STRATEGY_H
#define MCRL2_PG_LINEAR_LIFTING_STRATEGY_H
...
private:
    ...
    verti vertex_ = NO_VERTEX;  //!< next vertex to lift
...
#endif /* ndef MCRL2_PG_LINEAR_LIFTING_STRATEGY_H */
