...
void print_justification_tree_rec(const boolean_equation_system& b, const vector<bool>& solution, bool init_solution, const map<boolean_variable, int>& index_of, int indent, boolean_expression expr, set<boolean_variable>& visited)
{
...
void print_justification_tree(const boolean_equation_system& b, const vector<bool>& solution, bool init_solution)
{
  ...
  map<boolean_variable, int> index_of;
