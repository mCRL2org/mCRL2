...
///          This is caused by storing and protecting the intermediate value of the converted aterm_core. See Term t = convert_to_aterm(...).
...
aterm_core make_list_forward(Iter first, Iter last, ATermConverter convert_to_aterm);
...
aterm_core make_list_forward(Iter first, Iter last, ATermConverter convert_to_aterm, ATermFilter aterm_filter);
