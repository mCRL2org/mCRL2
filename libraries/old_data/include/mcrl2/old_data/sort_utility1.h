...
//prototype
bool is_finite(const data_operation_list& fl, const sort_expression& s, const mcrl2::old_data::sort_expression_list visited);
...
inline bool is_finite(const data_operation_list& fl, const mcrl2::old_data::sort_expression_list& sl, const mcrl2::old_data::sort_expression_list visited = mcrl2::old_data::sort_expression_list())
{
  bool result = true;
...
inline bool is_finite(const data_operation_list& fl, const sort_expression& s, const mcrl2::old_data::sort_expression_list visited = mcrl2::old_data::sort_expression_list())
{
  bool result = true;
