...
//
/// \file mcrl2/old_data/rewrite/innerc.h
...
{
	public:
		RewriterCompilingInnermost(mcrl2::old_data::data_specification DataSpec);
	...
	private:
		...
		void CompileRewriteSystem(mcrl2::old_data::data_specification DataSpec);
