...
//
/// \file mcrl2/old_data/data_variable.h
...
class data_variable: public data_expression
{
  public:
    ...
    data_variable(const std::string& s)
    {
      ...
      m_term = reinterpret_cast<ATerm>(core::detail::gsMakeDataVarId(core::detail::gsString2ATermAppl(name.c_str()), mcrl2::old_data::sort_expression(type)));
    }
    ...
    ///
    old_data::sort_expression sort() const
    {
...
/// \cond INTERNAL_DOCS
MCRL2_ATERM_TRAITS_SPECIALIZATION(mcrl2::old_data::data_variable)
/// \endcond
