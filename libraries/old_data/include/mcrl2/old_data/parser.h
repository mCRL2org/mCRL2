...
/// \endcond
  ...
  data_specification parse_data_specification(const std::string& text)
  {
    ...
    ATermAppl result = old_data::detail::parse_specification(lps_stream);
    result           = old_data::detail::type_check_specification(result);
    result           = old_data::detail::alpha_reduce(result);
    result           = old_data::detail::implement_data_specification(result);
