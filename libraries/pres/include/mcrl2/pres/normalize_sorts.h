// Author(s): Jan Friso Groote. Based on pbes/normalize_sorts by Wieger Wesselink
...
//
/// \file mcrl2/pres/normalize_sorts.h
/// \brief add your file description here.

#ifndef MCRL2_PRES_NORMALIZE_SORTS_H
#define MCRL2_PRES_NORMALIZE_SORTS_H
