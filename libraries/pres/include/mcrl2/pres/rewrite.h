...
{
  typedef Builder<rewrite_pres_expressions_builder<Builder, Rewriter> > super;
  using super::apply;
  using super::update;
...
{
  typedef Builder<rewrite_pres_expressions_with_substitution_builder<Builder, Rewriter, Substitution> > super;
  using super::apply;
