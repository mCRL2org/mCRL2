...
/// \param[out] t The reference into which the new eqinf is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new eqninf is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new condsm is constructed.
template <class... ARGUMENTS>
...
/// \param[out] t The reference into which the new condeq is constructed.
template <class... ARGUMENTS>
