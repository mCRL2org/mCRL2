...
REPLACE_FUNCTION_TEXT = '''template <typename T, typename Substitution>
...
if __name__ == "__main__":
    generate_code('../../lps/include/mcrl2/lps/substitute.h'          , 'lps'             , 'replace', REPLACE_FUNCTION_TEXT)
    generate_code('../../process/include/mcrl2/process/substitute.h'  , 'process'         , 'replace', REPLACE_FUNCTION_TEXT)
    generate_code('../../pbes/include/mcrl2/pbes/substitute.h'        , 'pbes_system'     , 'replace', REPLACE_FUNCTION_TEXT)
    generate_code('../../lps/include/mcrl2/modal_formula/substitute.h', 'action_formulas' , 'replace', REPLACE_FUNCTION_TEXT)
    generate_code('../../lps/include/mcrl2/modal_formula/substitute.h', 'regular_formulas', 'replace', REPLACE_FUNCTION_TEXT)
    generate_code('../../lps/include/mcrl2/modal_formula/substitute.h', 'state_formulas'  , 'replace', REPLACE_FUNCTION_TEXT)
