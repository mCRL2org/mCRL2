...
def make_traverser_new(filename, traverser, add_traverser, parent_traverser, class_map, all_classes, namespace, expression, dependencies):
...
if __name__ == "__main__":
    ...
    make_traverser_new('../../data/include/mcrl2/data/traverser.h'        , 'sort_expression_traverser', 'add_traverser_sort_expressions', 'core::traverser'                            , class_map, all_classes, 'data'            , 'data::sort_expression', sort_expression_dependencies)
    make_traverser_new('../../lps/include/mcrl2/lps/traverser.h'          , 'sort_expression_traverser', 'add_traverser_sort_expressions', 'data::sort_expression_traverser'            , class_map, all_classes, 'lps'             , 'data::sort_expression', sort_expression_dependencies)
    make_traverser_new('../../process/include/mcrl2/process/traverser.h'  , 'sort_expression_traverser', 'add_traverser_sort_expressions', 'lps::sort_expression_traverser'             , class_map, all_classes, 'process'         , 'data::sort_expression', sort_expression_dependencies)
    make_traverser_new('../../pbes/include/mcrl2/pbes/traverser.h'        , 'sort_expression_traverser', 'add_traverser_sort_expressions', 'data::sort_expression_traverser'            , class_map, all_classes, 'pbes_system'     , 'data::sort_expression', sort_expression_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'sort_expression_traverser', 'add_traverser_sort_expressions', 'lps::sort_expression_traverser'             , class_map, all_classes, 'action_formulas' , 'data::sort_expression', sort_expression_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'sort_expression_traverser', 'add_traverser_sort_expressions', 'action_formulas::sort_expression_traverser' , class_map, all_classes, 'regular_formulas', 'data::sort_expression', sort_expression_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'sort_expression_traverser', 'add_traverser_sort_expressions', 'regular_formulas::sort_expression_traverser', class_map, all_classes, 'state_formulas'  , 'data::sort_expression', sort_expression_dependencies)

    # data_expression_traverser
    make_traverser_new('../../data/include/mcrl2/data/traverser.h'        , 'data_expression_traverser', 'add_traverser_data_expressions', 'core::traverser'                            , class_map, all_classes, 'data'            , 'data::data_expression', data_expression_dependencies)
    make_traverser_new('../../lps/include/mcrl2/lps/traverser.h'          , 'data_expression_traverser', 'add_traverser_data_expressions', 'data::data_expression_traverser'            , class_map, all_classes, 'lps'             , 'data::data_expression', data_expression_dependencies)
    make_traverser_new('../../process/include/mcrl2/process/traverser.h'  , 'data_expression_traverser', 'add_traverser_data_expressions', 'lps::data_expression_traverser'             , class_map, all_classes, 'process'         , 'data::data_expression', data_expression_dependencies)
    make_traverser_new('../../pbes/include/mcrl2/pbes/traverser.h'        , 'data_expression_traverser', 'add_traverser_data_expressions', 'data::data_expression_traverser'            , class_map, all_classes, 'pbes_system'     , 'data::data_expression', data_expression_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'data_expression_traverser', 'add_traverser_data_expressions', 'lps::data_expression_traverser'             , class_map, all_classes, 'action_formulas' , 'data::data_expression', data_expression_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'data_expression_traverser', 'add_traverser_data_expressions', 'action_formulas::data_expression_traverser' , class_map, all_classes, 'regular_formulas', 'data::data_expression', data_expression_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'data_expression_traverser', 'add_traverser_data_expressions', 'regular_formulas::data_expression_traverser', class_map, all_classes, 'state_formulas'  , 'data::data_expression', data_expression_dependencies)

    # variable_traverser
    make_traverser_new('../../data/include/mcrl2/data/traverser.h'        , 'variable_traverser', 'add_traverser_variables', 'core::traverser'                     , class_map, all_classes, 'data'            , 'data::variable', variable_dependencies)
    make_traverser_new('../../lps/include/mcrl2/lps/traverser.h'          , 'variable_traverser', 'add_traverser_variables', 'data::variable_traverser'            , class_map, all_classes, 'lps'             , 'data::variable', variable_dependencies)
    make_traverser_new('../../process/include/mcrl2/process/traverser.h'  , 'variable_traverser', 'add_traverser_variables', 'lps::variable_traverser'             , class_map, all_classes, 'process'         , 'data::variable', variable_dependencies)
    make_traverser_new('../../pbes/include/mcrl2/pbes/traverser.h'        , 'variable_traverser', 'add_traverser_variables', 'data::variable_traverser'            , class_map, all_classes, 'pbes_system'     , 'data::variable', variable_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'variable_traverser', 'add_traverser_variables', 'lps::variable_traverser'             , class_map, all_classes, 'action_formulas' , 'data::variable', variable_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'variable_traverser', 'add_traverser_variables', 'action_formulas::variable_traverser' , class_map, all_classes, 'regular_formulas', 'data::variable', variable_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'variable_traverser', 'add_traverser_variables', 'regular_formulas::variable_traverser', class_map, all_classes, 'state_formulas'  , 'data::variable', variable_dependencies)

    # boolean_variable_traverser
    make_traverser_new('../../bes/include/mcrl2/bes/traverser.h', 'boolean_variable_traverser', 'add_traverser_boolean_variables', 'core::traverser', class_map, all_classes, 'bes', 'bes::boolean_variable', boolean_variable_dependencies)

    # identifier_string_traverser
    make_traverser_new('../../data/include/mcrl2/data/traverser.h'        , 'identifier_string_traverser', 'add_traverser_identifier_strings', 'core::traverser'                              , class_map, all_classes, 'data'            , 'core::identifier_string', identifier_string_dependencies)
    make_traverser_new('../../lps/include/mcrl2/lps/traverser.h'          , 'identifier_string_traverser', 'add_traverser_identifier_strings', 'data::identifier_string_traverser'            , class_map, all_classes, 'lps'             , 'core::identifier_string', identifier_string_dependencies)
    make_traverser_new('../../process/include/mcrl2/process/traverser.h'  , 'identifier_string_traverser', 'add_traverser_identifier_strings', 'lps::identifier_string_traverser'             , class_map, all_classes, 'process'         , 'core::identifier_string', identifier_string_dependencies)
    make_traverser_new('../../pbes/include/mcrl2/pbes/traverser.h'        , 'identifier_string_traverser', 'add_traverser_identifier_strings', 'data::identifier_string_traverser'            , class_map, all_classes, 'pbes_system'     , 'core::identifier_string', identifier_string_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'identifier_string_traverser', 'add_traverser_identifier_strings', 'lps::identifier_string_traverser'             , class_map, all_classes, 'action_formulas' , 'core::identifier_string', identifier_string_dependencies)
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'identifier_string_traverser', 'add_traverser_identifier_strings', 'action_formulas::identifier_string_traverser' , class_map, all_classes, 'regular_formulas', 'core::identifier_string', identifier_string_dependencies)
    ...
    make_traverser_new('../../process/include/mcrl2/process/traverser.h', 'process_expression_traverser', 'add_traverser_process_expressions', 'core::traverser', class_map, all_classes, 'process', 'process::process_expression', process_expression_dependencies)

    # state_formula_traverser
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'state_formula_traverser', 'add_traverser_state_formula_expressions', 'core::traverser', class_map, all_classes, 'state_formulas', 'state_formulas::state_formula', state_formula_dependencies)

    # action_formula_traverser
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'action_formula_traverser', 'add_traverser_action_formula_expressions', 'core::traverser', class_map, all_classes, 'action_formulas', 'action_formulas::action_formula', action_formula_dependencies)

    # regular_formula_traverser
    make_traverser_new('../../lps/include/mcrl2/modal_formula/traverser.h', 'regular_formula_traverser', 'add_traverser_regular_formula_expressions', 'core::traverser', class_map, all_classes, 'regular_formulas', 'regular_formulas::regular_formula', regular_formula_dependencies)
