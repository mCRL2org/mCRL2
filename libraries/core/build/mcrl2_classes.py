...
stochastic_operator(const data::variable_list& bound_variables, const data::data_expression& distribution, const process_expression& operand): public process::process_expression | EI  | StochasticOperator       | The distribution operator
