...
application(const data_expression& head, data_expression_list const& arguments)                               : public data::data_expression | EOUS | DataAppl          | An application of a data expression to a number of arguments
