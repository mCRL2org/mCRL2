...
BOOST_AUTO_TEST_CASE(test_is_container_impl)
{
  ...
  BOOST_CHECK(is_container_impl<atermpp::vector<bool> >::value);
  BOOST_CHECK(is_container_impl<atermpp::set<bool> >::value);
  BOOST_CHECK(is_container_impl<atermpp::multiset<bool> >::value);
...
BOOST_AUTO_TEST_CASE(test_is_set_impl)
{
  ...
  BOOST_CHECK(is_set_impl<atermpp::set<bool> >::value);
  BOOST_CHECK(is_set_impl<atermpp::multiset<bool> >::value);
}
