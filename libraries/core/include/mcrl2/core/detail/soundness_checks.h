...
template <typename Term> bool check_term_RESTrue(const Term& t);
template <typename Term> bool check_term_RESFalse(const Term& t);
template <typename Term> bool check_term_RESMinus(const Term& t);
...
template <typename Term> bool check_term_RESConstantMultiplyAlt(const Term& t);
...
template <typename Term> bool check_term_RESCondSm(const Term& t);
template <typename Term> bool check_term_RESCondEq(const Term& t);
...
template <typename Term>
bool check_rule_RES(const Term& t)
{
  utilities::mcrl2_unused(t);
#ifndef MCRL2_NO_SOUNDNESS_CHECKS
  return check_term_RES(t);
#else
  return true;
#endif // MCRL2_NO_SOUNDNESS_CHECKS
}
...
bool check_rule_RESExpression(const Term& t)
{
  utilities::mcrl2_unused(t);
#ifndef MCRL2_NO_SOUNDNESS_CHECKS
  return check_term_RESTrue(t)
         || check_term_RESFalse(t)
         || check_rule_RESVariable(t)
         || check_term_RESMinus(t)
         || check_term_RESAnd(t)
         || check_term_RESOr(t)
         || check_term_RESImp(t)
         || check_term_RESPlus(t)
         || check_term_RESConstantMultiply(t)
         || check_term_RESConstantMultiplyAlt(t)
         || check_rule_DataExpr(t)
         || check_term_RESEqInf(t)
         || check_term_RESEqNInf(t)
         || check_term_RESCondSm(t)
         || check_term_RESCondEq(t);
#else
  return true;
#endif // MCRL2_NO_SOUNDNESS_CHECKS
}
...
bool check_term_BES(const Term& t)
{
  ...
  {
    mCRL2log(log::debug) << "check_rule_BooleanEquation" << std::endl;
    return false;
  }
  if (!check_term_argument(a[1], check_rule_BooleanExpression<atermpp::aterm>))
  {
    mCRL2log(log::debug) << "check_rule_BooleanExpression" << std::endl;
    return false;
  }
#endif // MCRL2_NO_RECURSIVE_SOUNDNESS_CHECKS
...
bool check_term_BooleanEquation(const Term& t)
{
  ...
  {
    mCRL2log(log::debug) << "check_rule_BooleanVariable" << std::endl;
    return false;
  }
...
bool check_term_PRES(const Term& t)
{
  ...
  if (!check_term_argument(a[2], check_rule_PREqnSpec<atermpp::aterm>))
  {
    mCRL2log(log::debug, "soundness_checks") << "check_rule_PREqnSpec" << std::endl;
    return false;
  }
  if (!check_term_argument(a[3], check_rule_PRInit<atermpp::aterm>))
  {
    mCRL2log(log::debug, "soundness_checks") << "check_rule_PRInit" << std::endl;
    return false;
  }
#endif // MCRL2_NO_RECURSIVE_SOUNDNESS_CHECKS
...
#ifndef MCRL2_NO_RECURSIVE_SOUNDNESS_CHECKS
  if (!check_list_argument(a[0], check_rule_PREqn<atermpp::aterm>, 0))
  {
    mCRL2log(log::debug, "soundness_checks") << "check_rule_PREqn" << std::endl;
    return false;
  }
#endif // MCRL2_NO_RECURSIVE_SOUNDNESS_CHECKS
...
bool check_term_PREqn(const Term& t)
{
  ...
  if (!check_term_argument(a[2], check_rule_PRExpr<atermpp::aterm>))
  {
...
#ifndef MCRL2_NO_RECURSIVE_SOUNDNESS_CHECKS
  if (!check_term_argument(a[0], check_rule_PRExpr<atermpp::aterm>))
  {
    mCRL2log(log::debug, "soundness_checks") << "check_rule_PRExpr" << std::endl;
    return false;
  }
...
bool check_term_RES(const Term& t)
{
  ...
  const atermpp::aterm_appl& a = atermpp::down_cast<atermpp::aterm_appl>(term);
  if (a.function() != core::detail::function_symbols::RES)
  {
    return false;
  }
...
// RESTrue()
template <typename Term>
bool check_term_RESTrue(const Term& t)
{
  utilities::mcrl2_unused(t);
#ifndef MCRL2_NO_SOUNDNESS_CHECKS
  // check the type of the term
  ...
  const atermpp::aterm_appl& a = atermpp::down_cast<atermpp::aterm_appl>(term);
  if (a.function() != core::detail::function_symbols::RESTrue)
  {
    return false;
  }
...
// RESFalse()
template <typename Term>
bool check_term_RESFalse(const Term& t)
{
  utilities::mcrl2_unused(t);
#ifndef MCRL2_NO_SOUNDNESS_CHECKS
  // check the type of the term
  ...
  const atermpp::aterm_appl& a = atermpp::down_cast<atermpp::aterm_appl>(term);
  if (a.function() != core::detail::function_symbols::RESFalse)
  {
    return false;
  }
...
template <typename Term>
bool check_term_RESMinus(const Term& t)
{
  utilities::mcrl2_unused(t);
#ifndef MCRL2_NO_SOUNDNESS_CHECKS
  // check the type of the term
  ...
  const atermpp::aterm_appl& a = atermpp::down_cast<atermpp::aterm_appl>(term);
  if (a.function() != core::detail::function_symbols::RESMinus)
  {
    return false;
  }
...
template <typename Term>
bool check_term_RESConstantMultiplyAlt(const Term& t)
{
  utilities::mcrl2_unused(t);
#ifndef MCRL2_NO_SOUNDNESS_CHECKS
  // check the type of the term
  ...
  const atermpp::aterm_appl& a = atermpp::down_cast<atermpp::aterm_appl>(term);
  if (a.function() != core::detail::function_symbols::RESConstantMultiplyAlt)
  {
    return false;
  }
...
template <typename Term>
bool check_term_RESCondSm(const Term& t)
{
  utilities::mcrl2_unused(t);
#ifndef MCRL2_NO_SOUNDNESS_CHECKS
  // check the type of the term
  ...
  const atermpp::aterm_appl& a = atermpp::down_cast<atermpp::aterm_appl>(term);
  if (a.function() != core::detail::function_symbols::RESCondSm)
  {
    return false;
  }
...
template <typename Term>
bool check_term_RESCondEq(const Term& t)
{
  utilities::mcrl2_unused(t);
#ifndef MCRL2_NO_SOUNDNESS_CHECKS
  // check the type of the term
  ...
  const atermpp::aterm_appl& a = atermpp::down_cast<atermpp::aterm_appl>(term);
  if (a.function() != core::detail::function_symbols::RESCondEq)
  {
    return false;
  }
...
bool check_term_BddIf(const Term& t)
{
  ...
  {
    mCRL2log(log::debug) << "check_rule_BddExpression" << std::endl;
    return false;
  }
