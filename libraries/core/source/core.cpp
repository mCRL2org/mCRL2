...
const atermpp::function_symbol core::detail::function_symbols::SortCons = core::detail::function_symbol_SortCons();
  ...
  const atermpp::function_symbol core::detail::function_symbols::PRESMinall = core::detail::function_symbol_PRESMinall();
  const atermpp::function_symbol core::detail::function_symbols::PRESMaxall = core::detail::function_symbol_PRESMaxall();
  ...
  const atermpp::function_symbol core::detail::function_symbols::RESEquation = core::detail::function_symbol_RESEquation();
  const atermpp::function_symbol core::detail::function_symbols::RESVariable = core::detail::function_symbol_RESVariable();
  const atermpp::function_symbol core::detail::function_symbols::RESTrue = core::detail::function_symbol_RESTrue();
  const atermpp::function_symbol core::detail::function_symbols::RESFalse = core::detail::function_symbol_RESFalse();
  const atermpp::function_symbol core::detail::function_symbols::RESMinus = core::detail::function_symbol_RESMinus();
  const atermpp::function_symbol core::detail::function_symbols::RESAnd = core::detail::function_symbol_RESAnd();
  const atermpp::function_symbol core::detail::function_symbols::RESOr = core::detail::function_symbol_RESOr();
  const atermpp::function_symbol core::detail::function_symbols::RESImp = core::detail::function_symbol_RESImp();
  const atermpp::function_symbol core::detail::function_symbols::RESPlus = core::detail::function_symbol_RESPlus();
  const atermpp::function_symbol core::detail::function_symbols::RESConstantMultiply = core::detail::function_symbol_RESConstantMultiply();
  const atermpp::function_symbol core::detail::function_symbols::RESConstantMultiplyAlt = core::detail::function_symbol_RESConstantMultiplyAlt();
  const atermpp::function_symbol core::detail::function_symbols::RESCondAnd = core::detail::function_symbol_RESCondAnd();
  const atermpp::function_symbol core::detail::function_symbols::RESCondOr = core::detail::function_symbol_RESCondOr();
  const atermpp::function_symbol core::detail::function_symbols::RESEqInf = core::detail::function_symbol_RESEqInf();
  const atermpp::function_symbol core::detail::function_symbols::RESEqNInf = core::detail::function_symbol_RESEqNInf();
...
const atermpp::aterm_appl core::detail::default_values::SortCons = core::detail::default_value_SortCons();
  ...
  const atermpp::aterm_appl core::detail::default_values::PRESMinall = core::detail::default_value_PRESMinall();
  const atermpp::aterm_appl core::detail::default_values::PRESMaxall = core::detail::default_value_PRESMaxall();
  ...
  const atermpp::aterm_appl core::detail::default_values::RESEquation = core::detail::default_value_RESEquation();
  const atermpp::aterm_appl core::detail::default_values::RESVariable = core::detail::default_value_RESVariable();
  const atermpp::aterm_appl core::detail::default_values::RESTrue = core::detail::default_value_RESTrue();
  const atermpp::aterm_appl core::detail::default_values::RESFalse = core::detail::default_value_RESFalse();
  const atermpp::aterm_appl core::detail::default_values::RESMinus = core::detail::default_value_RESMinus();
  const atermpp::aterm_appl core::detail::default_values::RESAnd = core::detail::default_value_RESAnd();
  const atermpp::aterm_appl core::detail::default_values::RESOr = core::detail::default_value_RESOr();
  const atermpp::aterm_appl core::detail::default_values::RESImp = core::detail::default_value_RESImp();
  const atermpp::aterm_appl core::detail::default_values::RESPlus = core::detail::default_value_RESPlus();
  const atermpp::aterm_appl core::detail::default_values::RESConstantMultiply = core::detail::default_value_RESConstantMultiply();
  const atermpp::aterm_appl core::detail::default_values::RESConstantMultiplyAlt = core::detail::default_value_RESConstantMultiplyAlt();
  const atermpp::aterm_appl core::detail::default_values::RESCondAnd = core::detail::default_value_RESCondAnd();
  const atermpp::aterm_appl core::detail::default_values::RESCondOr = core::detail::default_value_RESCondOr();
  const atermpp::aterm_appl core::detail::default_values::RESEqInf = core::detail::default_value_RESEqInf();
  const atermpp::aterm_appl core::detail::default_values::RESEqNInf = core::detail::default_value_RESEqNInf();
  ...
  const atermpp::aterm_appl core::detail::default_values::RESExpression = core::detail::default_value_RESExpression();
