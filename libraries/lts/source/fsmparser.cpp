...
#line 17 "fsmparser.yy"
typedef union YYSTYPE {
  ATermAppl aterm;
  int number;
} YYSTYPE;
/* Line 190 of yacc.c.  */
#line 131 "fsmparser.cpp"
...
{
       0,    36,    36,    35,    46,    49,    53,    56,    58,    60,
      64,    69,    68,    83,    85,    88,    97,   100,   109,   112,
     116,   122,   126,   128,   129,   133,   134,   137,   139,   143,
     148,   153,   151,   163,   166,   179,   182,   187,   204,   206
};
#endif
...
#line 83 "fsmparser.yy"
  ...
  case 14:
#line 86 "fsmparser.yy"
    { safe_assign((yyval.aterm), (yyvsp[0].aterm)) ;}
    break;

  case 15:
#line 89 "fsmparser.yy"
    {
  ...
  case 16:
#line 98 "fsmparser.yy"
    { safe_assign((yyval.aterm), (yyvsp[0].aterm)) ;}
    break;

  case 17:
#line 101 "fsmparser.yy"
    {
...
#line 188 "fsmparser.yy"
    {
	    ...
	    if ( label == NULL )
	    {
	    	unsigned int i = fsm_lexer_obj->fsm_lts->add_label((ATerm)(yyvsp[0].aterm),!strcmp("tau",ATgetName(ATgetAFun((yyvsp[0].aterm)))));
