...
class non_probabilistic_lts
{
  ...
  public:
     ...
     */
    non_probabilistic_lts()
     : m_nstates(0)
    {}

    /** \brief Creates a copy of the supplied LTS.
     * \param[in] l The LTS to copy. */
    non_probabilistic_lts(const non_probabilistic_lts& l):
    ...
    void swap(non_probabilistic_lts& l)
    {
      {
...
class lts: public non_probabilistic_lts<STATE_LABEL_T, ACTION_LABEL_T>
{
  public:

    typedef non_probabilistic_lts<STATE_LABEL_T, ACTION_LABEL_T> super;
