  ...
  namespace lts
  {
    ...
    class lts
    {
      ...
      public:
         ...
         * \retval false otherwise.*/
        void
        write_to(std::string const& filename, lts_type type = lts_mcrl2, lts_extra extra = lts_no_extra) const;
         ...
         * \retval false otherwise.*/
        void
        write_to(std::ostream &os, lts_type type = lts_mcrl2, lts_extra extra = lts_no_extra) const;
        ...
        bool
        hide_actions(const std::vector<std::string> &tau_actions);
        ...
        void
        set_creator(std::string creator);
         ...
         * \pre            States have parameters. */
        ATerm
        state_parameter_name(unsigned int idx) const;
         ...
         * \pre            States have parameters. */
        std::string
        state_parameter_name_str(unsigned int idx) const;
         ...
         * \pre            States have parameters. */
        ATerm
        state_parameter_sort(unsigned int idx) const;
         ...
         * \pre            States have parameters. */
        std::string
        state_parameter_sort_str(unsigned int idx) const;
         ...
         * \pre              States have parameters. */
        ATerm
        get_state_parameter_value(unsigned int state, unsigned int idx) const;
         ...
         * \pre              States have parameters. */
        std::string
        get_state_parameter_value_str(unsigned int state, unsigned int idx) const;
         ...
         * \pre            States have parameters. */
        atermpp::set<ATerm>
        get_state_parameter_values(unsigned int idx);
        ...
        std::string
        pretty_print_label_value(ATerm value);
        ...
        std::string
        pretty_print_state_value(ATerm value) const;
        ...
        std::string
        pretty_print_state_parameter_value(ATerm value);
        ...
        void
        set_data_specification(data::data_specification const& spec);

        /** \brief Sorts the transitions using a sort style.
         * \param[in] ts The sort style to use. */
        void
        sort_transitions(transition_sort_style ts = src_lbl_tgt);
