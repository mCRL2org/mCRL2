...
enum lts_equivalence
{
  ...
  lts_eq_bisim_tb,         /**< Strong bisimulation equivalence using the O(m log n) algorithm directly on an LTS; experimental. */
  ...
  lts_eq_branching_bisim_tb,     /**< Branching bisimulation equivalence using the O(m log n) algorithm directly on an LTS; experimental */
  ...
  lts_eq_divergence_preserving_branching_bisim_tb,    /**< Divergence-preserving branching bisimulation equivalence using the O(m log n) algorithm directly on an LTS; experimental */
...
lts_equivalence parse_equivalence(std::string const& s)
{
  ...
  else if (s == "branching-bisim-tb")
  {
      return lts_eq_branching_bisim_tb;
  }
  ...
  else if (s == "dpbranching-bisim-tb")
  {
    return lts_eq_divergence_preserving_branching_bisim_tb;
  }
