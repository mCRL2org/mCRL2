...
///
/// The helper class also initialises the variables used by `MAX_ITERATIONS` to
...
public:
    ...
    {
        // INIT_MAX_ITERATIONS_STATES(0);
        // INIT_MAX_ITERATIONS_TRANSITIONS(0);
    }
...
public:
        ...
        part_tr(init_helper.get_nr_of_transitions())
    {
        ...
        assert(0 == bisim_gjkw::constln_t::nr_of_constlns);
