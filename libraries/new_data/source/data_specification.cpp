...
std::clog << "ADDING " << pp(sort) << std::endl;
      ...
      {
        structured_sort a_structured_sort;

        add_system_defined_sort(sort);
        add_system_defined_constructors(boost::make_iterator_range(a_structured_sort.constructor_functions(sort)));
        add_system_defined_mappings(boost::make_iterator_range(a_structured_sort.projection_equations(sort)));
        add_system_defined_mappings(boost::make_iterator_range(a_structured_sort.recogniser_functions(sort)));
        add_system_defined_equations(boost::make_iterator_range(a_structured_sort.constructor_equations(sort)));
        add_system_defined_equations(boost::make_iterator_range(a_structured_sort.projection_equations(sort)));
        add_system_defined_equations(boost::make_iterator_range(a_structured_sort.recogniser_functions(sort)));
      }
    }
