...
\dataclass
  ...
  {\begin{description}
    ...
    \item[is\_unary] Returns whether this is a unary function.
    \item[is\_binary] Returns whether this is a binary function.
    \item[is\_ternary] Returns whether this is a ternary function.
...
\dataclass
  ...
  {\begin{itemize}
    ...
    \item forall
    \item exists
    \item set\_comprehension
    \item bag\_comprehension
   \end{itemize}}
  {\begin{description}
    ...
    \item[is\_set\_comprehension] Returns \true iff the abstraction is a set comprehension.
    \item[is\_bag\_comprehension] Returns \true iff the abstraction is a bag comprehension.
   \end{description}}
...
\dataclass
  {set\_comprehension}
  {This denotes a set comprehension, e.g. $\{ x_0, \dots, x_n \mid t \}$.}
  {abstraction}
  {}
  {}
...
\dataclass
  {bag\_comprehension}
  {This denotes a bag comprehension, e.g. $\{ x_0 : m_0, \dots, x_n : m_0 \mid t \}$ (with $m_i$ the number of occurrences of $x_i$.}
  {abstraction}
  {}
  {}
...
\dataclass
  ...
  {\begin{description}
    ...
    \item[functions] Returns all functions declared in the specification.
    ...
    \item[functions(sort)] Returns all functions which have $sort$ as a result.
    ...
    \item[add\_function] Adds a function to the specification.
    ...
    \item[add\_functions(fl)] Adds all functions in $fl$ to the specification.
