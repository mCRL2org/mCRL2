...
//
/// \file mcrl2/new_data/detail/enumeration.h
/// \brief Template class for substitution

#ifndef _MCRL2_NEW_DATA_DETAIL_CLASSIC_ENUMERATOR__HPP_
#define _MCRL2_NEW_DATA_DETAIL_CLASSIC_ENUMERATOR__HPP_
      ...
      class classic_enumerator_impl {
        ...
        public:
          ...
          static void create(boost::shared_ptr< classic_enumerator_impl >& target,
            ...
            /// Limitations in EnumeratorStandard force passing a rewriter
            /// e.get_rewriter() is not required but at this moment new_data::rewriter is the currently only model of Evaluator
