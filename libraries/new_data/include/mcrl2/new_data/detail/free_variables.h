...
struct variable_collector
{
  ...
  variable_collector(InputIterator1 first1,
...
template <typename InputIterator1, typename InputIterator2, typename OutputIterator>
variable_collector<InputIterator1, InputIterator2, OutputIterator>
make_variable_collector(InputIterator1 first1,
                             InputIterator1 last1,
                             InputIterator2 first2,
                             InputIterator2 last2,
                             OutputIterator dest
...
{
  return variable_collector<InputIterator1, InputIterator2, OutputIterator>(first1, last1, first2, last2, dest);
}
