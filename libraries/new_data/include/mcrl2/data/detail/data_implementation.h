...
/** \brief     Implement new_data types of a type checked mCRL2 new_data
 *             specification.
 *  \param[in] spec An ATerm representation of an mCRL2 new_data
 ...
 *             abstract new_data types.
 *  \return    If the new_data implementation went well, an equivalent
 *             version of spec is returned that adheres to the internal
 *             ATerm structure after new_data implementation.  If something
...
/** \brief     Implement new_data types of a type checked mCRL2 process
 *             specification.
...
/** \brief     Implement new_data types of a type checked mCRL2 parameterised
...
/** \brief     Implement new_data types of a type checked mCRL2 sort
 ...
 *             after the type checking phase.
 *  \param[in] spec An ATerm representation of an mCRL2 process
 *             specification, LPS, PBES or new_data specification that
 *             adheres to the internal ATerm structure after the type
 *             checking phase.
 *  \post      The new_data types of sort_expr are implemented as
 *             higher-order abstract new_data types in spec.
 *             spec is updated to be the equivalent of spec in the
 *             internal format after new_data implementation.
 *  \return    If the new_data implementation went well, an equivalent
 *             version of sort_expr is returned that adheres to the
 *             internal ATerm structure after new_data implementation.  If
...
/** \brief     Implement new_data types of a type checked mCRL2 new_data expression
 *             with respect to a type checked mCRL2 specification.
 *  \param[in] data_expr An ATerm representation of an mCRL2 new_data
 *             expression that adheres to the internal ATerm structure
 *             after the type checking phase.
 *  \param[in] spec An ATerm representation of an mCRL2 process
 *             specification, LPS, PBES or new_data specification that
 *             adheres to the internal ATerm structure after the type
 *             checking phase.
 *  \post      The new_data types of data_expr are implemented as
 *             higher-order abstract new_data types in spec.
 *             spec is updated to be the equivalent of spec in the
 *             internal format after new_data implementation.
 *  \return    If the new_data implementation went well, an equivalent
...
/** \brief     Implement new_data types of a type checked mCRL2 multiaction
 *             with respect to a type checked mCRL2 specification.
 ...
 *             adheres to the internal ATerm structure after the type
 *             checking phase.
 *  \post      The new_data types of mult_act are implemented as
 *             higher-order abstract new_data types in spec.
 *             spec is updated to be the equivalent of spec in the
 *             internal format after new_data implementation.
 *  \return    If the new_data implementation went well, an equivalent
 ...
 *             adheres to the internal ATerm structure after the type
 *             checking phase.
 *  \post      The new_data types of proc_expr are implemented as
 *             higher-order abstract new_data types in spec.
 *             spec is updated to be the equivalent of spec in the
 *             internal format after new_data implementation.
 *  \return    If the new_data implementation went well, an equivalent
...
/** \brief     Implement new_data types of a type checked mCRL2 state formula
 *             with respect to a type checked mCRL2 specification.
 ...
 *             adheres to the internal ATerm structure after the type
 *             checking phase.
 *  \post      The new_data types of state_frm are implemented as
 *             higher-order abstract new_data types in spec.
 *             spec is updated to be the equivalent of spec in the
 *             internal format after new_data implementation.
 *  \return    If the new_data implementation went well, an equivalent
...
/** \brief     Implement new_data types of a type checked mCRL2 action rename
 ...
 *  \post      The new_data types in action_rename_spec are implemented as
 *             higher-order abstract new_data types types and the new_data types
 *             of lps_spec are added to the new_data types of ar_spec.  The
 *             datatypes of lps_spec are implemented as higher-order
 *             abstract new_data types in lps_spec
 *  \return    If the new_data implementation went well, an equivalent
