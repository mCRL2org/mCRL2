...
set(MCRL2_MAJOR_VERSION "202607.0")
...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git")
  ...
  # Store the git revision into the SourceVersion file
...
if("${MCRL2_MINOR_VERSION}" STREQUAL "Unknown")
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/SourceVersion")
    ...
    message(WARNING "No version information could be included because ${CMAKE_CURRENT_SOURCE_DIR} is unversioned.")
  endif()
endif()
...
if(CMAKE_SCRIPT_MODE_FILE AND CMAKE_SCRIPT_MODE_FILE STREQUAL CMAKE_PARENT_LIST_FILE)
  ...
  if(GENERATOR_IS_MULTI_CONFIG)
    add_definitions(-DMCRL2_BUILD_TYPE=$<CONFIG>)
  else()
