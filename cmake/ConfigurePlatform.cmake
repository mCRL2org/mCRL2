...
elseif(UNIX)
  ...
  if(APPLE)
    ...
    install(DIRECTORY ${mCRL2_SOURCE_DIR}/cmake/packaging/icons/hicolor DESTINATION share/icons)
...
# The full path to the directory containing the tools, depends on whether it is a multi-configuration
if(CMAKE_CONFIGURATION_TYPES)
  set(MCRL2_TOOL_PATH ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/$<CONFIG>)
else()
  set(MCRL2_TOOL_PATH ${CMAKE_RUNTIME_OUTPUT_DIRECTORY})
endif()
